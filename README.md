...
All codelets are generated by Python scripts with ISA-specific scheduling (register allocation, spill management, FMA pipelining).
...
- [FFTW](http://www.fftw.org/) by Matteo Frigo and Steven G. Johnson -- the gold standard for decades. VectorFFT's prime-radix codelets (R=11, 13, 17, 19) are translated from FFTW's genfft algebraic output.
