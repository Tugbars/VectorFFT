...
int main(void)
{
    extern void radix16_z_n1b_fwd_avx2(const double *, const double *, double *, double *,
        const double *, const double *, unsigned long long, unsigned long long,
        unsigned long long, unsigned long long, unsigned long long);
    extern void radix32_z_n1b_fwd_avx2(const double *, const double *, double *, double *,
        const double *, const double *, unsigned long long, unsigned long long,
        unsigned long long, unsigned long long, unsigned long long);
    extern void radix64_z_n1b_fwd_avx2(const double *, const double *, double *, double *,
        const double *, const double *, unsigned long long, unsigned long long,
        unsigned long long, unsigned long long, unsigned long long);
    struct { int R; zn1_fn f; } cs[] = {
        ...
        { 16, radix16_z_n1b_fwd_avx2 }, { 32, radix32_z_n1b_fwd_avx2 },
        { 64, radix64_z_n1b_fwd_avx2 },
    };
    int fails = 0;
    const int K = 8;
     ...
     * consumption order) applied to legs>=1, then the R-DFT ---- */
    {
        ...
        extern void radix32_z_t2_fwd_avx2(const double *, const double *, double *, double *,
            const double *, const double *, unsigned long long, unsigned long long,
            unsigned long long, unsigned long long, unsigned long long);
        extern void radix16_z_t2b_fwd_avx2(const double *, const double *, double *, double *,
            const double *, const double *, unsigned long long, unsigned long long,
            unsigned long long, unsigned long long, unsigned long long);
        extern void radix32_z_t2b_fwd_avx2(const double *, const double *, double *, double *,
            const double *, const double *, unsigned long long, unsigned long long,
            unsigned long long, unsigned long long, unsigned long long);
        struct { int R; zn1_fn f; } ts[] = {
            ...
            { 16, radix16_z_t2b_fwd_avx2 },
            { 32, radix32_z_t2b_fwd_avx2 },
        };
