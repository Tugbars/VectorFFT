...
WISDOM       = ROOT / 'src' / 'wisdom'           # the wisdom2 store (2026-09-24)
...
def build_cmd(tc, src_c, out_bin, mkl=False, fftw=False, jit=False, extra_srcs=None,
    ...
    flags = ['-O3', '-mavx2', '-mfma', '-march=native', '-fpermissive',
             ...
             '-DVFFT_WISDOM_DIR_DEFAULT="%s"' % WISDOM.as_posix(),   # the store (2026-09-24)
             '-DVFFT_FROZEN_WISDOM_DIR="%s"' % DAG_GEN.as_posix(),   # the frozen bundle
