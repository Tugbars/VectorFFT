/* adversarial reach probe for the il2d wl/roop axis race */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "vfft.h"
...
static const cell_t CELLS[] = {
  {"A.2d.il.ip.c2c.16x64.def",  C2C,IL,IP,DEF,2, 16, 64,1},
  {"B.2d.il.oop.c2c.16x64.def", C2C,IL,OP,DEF,2, 16, 64,1},
  {"C.2d.il.oop.c2c.16x64.nat", C2C,IL,OP,NAT,2, 16, 64,1},
  {"D.2d.il.ip.c2c.16x64.nat",  C2C,IL,IP,NAT,2, 16, 64,1},
  {"E.2d.il.ip.c2c.64x64.def",  C2C,IL,IP,DEF,2, 64, 64,1},
  {"F.2d.il.oop.c2c.64x64.def", C2C,IL,OP,DEF,2, 64, 64,1},
  {"G.2d.il.ip.c2c.256x256.def",C2C,IL,IP,DEF,2,256,256,1},
  {"H.2d.il.oop.c2c.256.nat",   C2C,IL,OP,NAT,2,256,256,1},
  {"I.2d.il.oop.c2c.16x64.scr", C2C,IL,OP,SCR,2, 16, 64,1},
  {"J.2d.il.ip.c2c.32x128.def", C2C,IL,IP,DEF,2, 32,128,1},
  {"K.2d.sp.ip.c2c.16x64.def",  C2C,SP,IP,DEF,2, 16, 64,1},
  {"L.2d.il.oop.r2c.16x64.def", R2C,IL,OP,DEF,2, 16, 64,1},
  {"M.2d.il.ip.c2c.16x64.K2",   C2C,IL,IP,DEF,2, 16, 64,2},
};
