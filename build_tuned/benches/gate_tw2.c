/* Gate: t1_dit fwd il_out, t1_dit_log3 fwd il_out, t1_dif_log3 fwd il_in */
...
#define C(a,b) C2(a,b)
#define D(R) \
 void C(radix##R##_t1_dit_fwd_,I)(double*,double*,const double*,const double*,size_t,size_t); \
 void C(radix##R##_t1_dit_log3_fwd_,I)(double*,double*,const double*,const double*,size_t,size_t); \
 void C(radix##R##_t1_dif_log3_fwd_,I)(double*,double*,const double*,const double*,size_t,size_t); \
 void C(radix##R##_t1_dit_fwd_,C(I,_il_out))(const double*,const double*,double*,const double*,const double*,size_t,size_t); \
 void C(radix##R##_t1_dit_log3_fwd_,C(I,_il_out))(const double*,const double*,double*,const double*,const double*,size_t,size_t); \
 void C(radix##R##_t1_dif_log3_fwd_,C(I,_il_in))(const double*,double*,double*,const double*,const double*,size_t,size_t);
...
#define RUN(R) for(int m=0;m<3;m++){ size_t me=(size_t[]){64,65,67}[m]; \
  ok&=go(R,"t1dit  ilo",C(radix##R##_t1_dit_fwd_,I),C(radix##R##_t1_dit_fwd_,C(I,_il_out)),me,71+m); \
  ok&=go(R,"t1ditL3 ilo",C(radix##R##_t1_dit_log3_fwd_,I),C(radix##R##_t1_dit_log3_fwd_,C(I,_il_out)),me,81+m); \
  ok&=gi(R,"t1difL3 ili",C(radix##R##_t1_dif_log3_fwd_,I),C(radix##R##_t1_dif_log3_fwd_,C(I,_il_in)),me,91+m); }
