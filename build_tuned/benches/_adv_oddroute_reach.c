/* _adv_oddroute_reach.c - does the ODD-MID commit-site route race reach
 * BOTH layouts / only OOP-SCRAMBLED?  N = 6144 = 2^11 * 3. */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "vfft.h"
...
static const cell_t CELLS[] = {
  {"il.oop.scr.6144", C2C,IL,OP,SCR,1,6144,0,1},
  {"sp.oop.scr.6144", C2C,SP,OP,SCR,1,6144,0,1},
  {"il.oop.def.6144", C2C,IL,OP,DEF,1,6144,0,1},
  {"sp.oop.def.6144", C2C,SP,OP,DEF,1,6144,0,1},
  {"il.ip.scr.6144",  C2C,IL,IP,SCR,1,6144,0,1},
  {"sp.ip.scr.6144",  C2C,SP,IP,SCR,1,6144,0,1},
  {"il.oop.nat.6144", C2C,IL,OP,NAT,1,6144,0,1},
  {"il.oop.scr.6144.K2", C2C,IL,OP,SCR,1,6144,0,2},
  {"il.oop.scr.1536", C2C,IL,OP,SCR,1,1536,0,1},
