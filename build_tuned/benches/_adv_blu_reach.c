/* _adv_blu_reach.c - reach probe for the 2D column-axis Bluestein (il2d.blu). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "vfft.h"
...
static const cell_t CELLS[] = {
  ...
  {"2d.il.oop.r2c.127x100.scr",R2C,IL,OP,SCR,2,127,100,1},
  {"2d.sp.oop.c2c.127x100",    C2C,SP,OP,DEF,2,127,100,1},
  {"2d.sp.oop.r2c.127x100",    R2C,SP,OP,DEF,2,127,100,1},
  /* odd-composite N1 (a chain EXISTS): does the chain-vs-blu race fire? */
  {"2d.il.oop.c2c.15x64",      C2C,IL,OP,DEF,2, 15, 64,1},
