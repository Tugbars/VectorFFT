    ...
    int sub_len)
{
    ...
    {
        // Prefetch ahead
        PREFETCH_11_LANES_R11(k, K, PREFETCH_L1_R11, sub_outputs, _MM_HINT_T0);
        ...
        RADIX11_IMAG_PAIR1_BV_AVX2(s0, s1, s2, s3, s4, rot1);  // BV version
        __m256d y1, y10;
        ...
        RADIX11_IMAG_PAIR2_BV_AVX2(s0, s1, s2, s3, s4, rot2);  // BV version
        __m256d y2, y9;
        ...
        RADIX11_IMAG_PAIR3_BV_AVX2(s0, s1, s2, s3, s4, rot3);  // BV version
        __m256d y3, y8;
        ...
        RADIX11_IMAG_PAIR4_BV_AVX2(s0, s1, s2, s3, s4, rot4);  // BV version
        __m256d y4, y7;
        ...
        RADIX11_IMAG_PAIR5_BV_AVX2(s0, s1, s2, s3, s4, rot5);  // BV version
        __m256d y5, y6;
