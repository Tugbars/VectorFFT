//==============================================================================
// fft_radix11_fv.c - Radix-11 Butterfly (FORWARD Transform)
//==============================================================================
    ...
    int sub_len)
{
    ...
    for (; k + 1 < K; k += 2)
    {
        ...
        RADIX11_IMAG_PAIR1_FV_AVX2(s0, s1, s2, s3, s4, rot1);
        __m256d y1, y10;
        ...
        RADIX11_IMAG_PAIR2_FV_AVX2(s0, s1, s2, s3, s4, rot2);
        __m256d y2, y9;
        ...
        RADIX11_IMAG_PAIR3_FV_AVX2(s0, s1, s2, s3, s4, rot3);
        __m256d y3, y8;
        ...
        RADIX11_IMAG_PAIR4_FV_AVX2(s0, s1, s2, s3, s4, rot4);
        __m256d y4, y7;
        ...
        RADIX11_IMAG_PAIR5_FV_AVX2(s0, s1, s2, s3, s4, rot5);
        __m256d y5, y6;
