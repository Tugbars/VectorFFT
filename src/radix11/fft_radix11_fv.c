//==============================================================================
// fft_radix11_fv.c - Radix-11 Forward Butterfly (with AVX-512 support)
//==============================================================================
    ...
    int sub_len)
{
...
#ifdef __AVX512F__
    //==========================================================================
    // AVX-512 PATH: Process 4 butterflies per iteration
    //==========================================================================
    
    // Broadcast constants ONCE for entire function
    radix11_consts_avx512 K512 = broadcast_radix11_consts_avx512();
    
    for (; k + 3 < K; k += 4)
    {
        // Step 1: Load 11 lanes for 4 butterflies
        ...
        __m512d t0, t1, t2, t3, t4;  // Sums
        __m512d s0, s1, s2, s3, s4;  // Diffs
        __m512d y0;
        ...
        RADIX11_IMAG_PAIR1_FV_AVX512(s0, s1, s2, s3, s4, K512, rot1);
        __m512d y1, y10;
        ...
        RADIX11_IMAG_PAIR2_FV_AVX512(s0, s1, s2, s3, s4, K512, rot2);
        __m512d y2, y9;
        ...
        RADIX11_IMAG_PAIR3_FV_AVX512(s0, s1, s2, s3, s4, K512, rot3);
        __m512d y3, y8;
        ...
        RADIX11_IMAG_PAIR4_FV_AVX512(s0, s1, s2, s3, s4, K512, rot4);
        __m512d y4, y7;
        ...
        RADIX11_IMAG_PAIR5_FV_AVX512(s0, s1, s2, s3, s4, K512, rot5);
        __m512d y5, y6;
        RADIX11_ASSEMBLE_PAIR_AVX512(real5, rot5, y5, y6);
        
        // Step 9: Store 11 outputs for 4 butterflies
    ...
    // Broadcast constants ONCE for AVX2 section
    ...
    for (; k + 1 < K; k += 2)
    {
        ...
        RADIX11_IMAG_PAIR1_FV_AVX2(s0, s1, s2, s3, s4, K2, rot1);
        __m256d y1, y10;
        ...
        RADIX11_IMAG_PAIR2_FV_AVX2(s0, s1, s2, s3, s4, K2, rot2);
        __m256d y2, y9;
        ...
        RADIX11_IMAG_PAIR3_FV_AVX2(s0, s1, s2, s3, s4, K2, rot3);
        __m256d y3, y8;
        ...
        RADIX11_IMAG_PAIR4_FV_AVX2(s0, s1, s2, s3, s4, K2, rot4);
        __m256d y4, y7;
        ...
        RADIX11_IMAG_PAIR5_FV_AVX2(s0, s1, s2, s3, s4, K2, rot5);
        __m256d y5, y6;
...
//==============================================================================
// fft_radix11_bv.c - Radix-11 Backward/Inverse Butterfly (with AVX-512 support)
//==============================================================================
    ...
    int sub_len)
{
    ...
    for (; k + 3 < K; k += 4)
    {
        ...
        // Step 4-8: Compute 5 conjugate pairs (BV uses +i rotation)
        
        // Pair 1: Y_1, Y_10
        __m512d real1, rot1;
        RADIX11_REAL_PAIR1_AVX512(a, t0, t1, t2, t3, t4, K512, real1);
        RADIX11_IMAG_PAIR1_BV_AVX512(s0, s1, s2, s3, s4, K512, rot1);  // BV!
        __m512d y1, y10;
        RADIX11_ASSEMBLE_PAIR_AVX512(real1, rot1, y1, y10);
        ...
        __m512d real2, rot2;
        RADIX11_REAL_PAIR2_AVX512(a, t0, t1, t2, t3, t4, K512, real2);
        RADIX11_IMAG_PAIR2_BV_AVX512(s0, s1, s2, s3, s4, K512, rot2);  // BV!
        __m512d y2, y9;
        RADIX11_ASSEMBLE_PAIR_AVX512(real2, rot2, y2, y9);
        ...
        __m512d real3, rot3;
        RADIX11_REAL_PAIR3_AVX512(a, t0, t1, t2, t3, t4, K512, real3);
        RADIX11_IMAG_PAIR3_BV_AVX512(s0, s1, s2, s3, s4, K512, rot3);  // BV!
        __m512d y3, y8;
        RADIX11_ASSEMBLE_PAIR_AVX512(real3, rot3, y3, y8);
        ...
        __m512d real4, rot4;
        RADIX11_REAL_PAIR4_AVX512(a, t0, t1, t2, t3, t4, K512, real4);
        RADIX11_IMAG_PAIR4_BV_AVX512(s0, s1, s2, s3, s4, K512, rot4);  // BV!
        __m512d y4, y7;
        RADIX11_ASSEMBLE_PAIR_AVX512(real4, rot4, y4, y7);
        ...
        __m512d real5, rot5;
        RADIX11_REAL_PAIR5_AVX512(a, t0, t1, t2, t3, t4, K512, real5);
        RADIX11_IMAG_PAIR5_BV_AVX512(s0, s1, s2, s3, s4, K512, rot5);  // BV!
        __m512d y5, y6;
        RADIX11_ASSEMBLE_PAIR_AVX512(real5, rot5, y5, y6);
    ...
    for (; k + 1 < K; k += 2)
    {
        ...
        __m256d real1, rot1;
        RADIX11_REAL_PAIR1_AVX2(a, t0, t1, t2, t3, t4, K2, real1);
        RADIX11_IMAG_PAIR1_BV_AVX2(s0, s1, s2, s3, s4, K2, rot1);  // BV!
        __m256d y1, y10;
        RADIX11_ASSEMBLE_PAIR_AVX2(real1, rot1, y1, y10);
        ...
        __m256d real2, rot2;
        RADIX11_REAL_PAIR2_AVX2(a, t0, t1, t2, t3, t4, K2, real2);
        RADIX11_IMAG_PAIR2_BV_AVX2(s0, s1, s2, s3, s4, K2, rot2);  // BV!
        __m256d y2, y9;
        RADIX11_ASSEMBLE_PAIR_AVX2(real2, rot2, y2, y9);
        ...
        __m256d real3, rot3;
        RADIX11_REAL_PAIR3_AVX2(a, t0, t1, t2, t3, t4, K2, real3);
        RADIX11_IMAG_PAIR3_BV_AVX2(s0, s1, s2, s3, s4, K2, rot3);  // BV!
        __m256d y3, y8;
        RADIX11_ASSEMBLE_PAIR_AVX2(real3, rot3, y3, y8);
        ...
        __m256d real4, rot4;
        RADIX11_REAL_PAIR4_AVX2(a, t0, t1, t2, t3, t4, K2, real4);
        RADIX11_IMAG_PAIR4_BV_AVX2(s0, s1, s2, s3, s4, K2, rot4);  // BV!
        __m256d y4, y7;
        RADIX11_ASSEMBLE_PAIR_AVX2(real4, rot4, y4, y7);
        ...
        __m256d real5, rot5;
        RADIX11_REAL_PAIR5_AVX2(a, t0, t1, t2, t3, t4, K2, real5);
        RADIX11_IMAG_PAIR5_BV_AVX2(s0, s1, s2, s3, s4, K2, rot5);  // BV!
        __m256d y5, y6;
        RADIX11_ASSEMBLE_PAIR_AVX2(real5, rot5, y5, y6);
