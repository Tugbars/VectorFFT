...
__attribute__((target("avx512f,avx512dq,fma"))) static void radix11_genfft_fwd_avx512(
    const double *R11_RESTRICT in_re, const double *R11_RESTRICT in_im,
    double *R11_RESTRICT out_re, double *R11_RESTRICT out_im,
    size_t K)
{
...
__attribute__((target("avx512f,avx512dq,fma"))) static void radix11_genfft_bwd_avx512(
    const double *R11_RESTRICT in_re, const double *R11_RESTRICT in_im,
    double *R11_RESTRICT out_re, double *R11_RESTRICT out_im,
    size_t K)
{
...
__attribute__((target("avx2,fma"))) static void radix11_genfft_bwd_avx2(
    const double *R11_RESTRICT in_re, const double *R11_RESTRICT in_im,
    double *R11_RESTRICT out_re, double *R11_RESTRICT out_im,
    size_t K)
{
