 ...
 * @brief Radix-7 Rader butterfly — ISA-uniform dispatch interface
 *
 * Provides:
...
static inline const char *fft_r7_isa_name(fft_r7_isa_t isa) {
    switch (isa) {
        case FFT_R7_ISA_AVX512: return "AVX-512";
        case FFT_R7_ISA_AVX2:   return "AVX2";
        case FFT_R7_ISA_SSE2:   return "SSE2";
