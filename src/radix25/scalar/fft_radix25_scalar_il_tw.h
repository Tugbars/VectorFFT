/**
 * @file fft_radix25_scalar_il_tw.h
 * @brief SCALAR DIT twiddled DFT-25 (5×5 CT) — interleaved + log3
 * Generated by gen_r25_log3.py
 */

#ifndef FFT_RADIX25_SCALAR_IL_TW_H
#define FFT_RADIX25_SCALAR_IL_TW_H
#include <stddef.h>
...
static void
radix25_tw_flat_dit_kernel_fwd_il_scalar(
...
static void
radix25_tw_flat_dit_kernel_bwd_il_scalar(
    const double * __restrict__ in,
    double * __restrict__ out,
    const double * __restrict__ tw_re, const double * __restrict__ tw_im,
    size_t K)
...
#endif /* FFT_RADIX25_SCALAR_IL_TW_H */
