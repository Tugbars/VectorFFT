/**
 * @file fft_radix8_avx512_dif_tw.h
 * @brief DFT-8 AVX512 DIF tw codelets with log3 derivation
 * Generated by gen_r8_log3.py
 */
#ifndef FFT_RADIX8_AVX512_DIF_TW_H
#define FFT_RADIX8_AVX512_DIF_TW_H
#include <stddef.h>
#include <immintrin.h>
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        ...
        { const __m512d tr = _mm512_fmsub_pd(Y1r,tw1r,_mm512_mul_pd(Y1i,tw1i));
          ...
          _mm512_store_pd(&out_re[1*K+k],tr); _mm512_store_pd(&out_im[1*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y2r,tw2r,_mm512_mul_pd(Y2i,tw2i));
          ...
          _mm512_store_pd(&out_re[2*K+k],tr); _mm512_store_pd(&out_im[2*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y3r,tw3r,_mm512_mul_pd(Y3i,tw3i));
          ...
          _mm512_store_pd(&out_re[3*K+k],tr); _mm512_store_pd(&out_im[3*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y4r,tw4r,_mm512_mul_pd(Y4i,tw4i));
          ...
          _mm512_store_pd(&out_re[4*K+k],tr); _mm512_store_pd(&out_im[4*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y5r,tw5r,_mm512_mul_pd(Y5i,tw5i));
          ...
          _mm512_store_pd(&out_re[5*K+k],tr); _mm512_store_pd(&out_im[5*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y6r,tw6r,_mm512_mul_pd(Y6i,tw6i));
          ...
          _mm512_store_pd(&out_re[6*K+k],tr); _mm512_store_pd(&out_im[6*K+k],ti); }
        { const __m512d tr = _mm512_fmsub_pd(Y7r,tw7r,_mm512_mul_pd(Y7i,tw7i));
          ...
          _mm512_store_pd(&out_re[7*K+k],tr); _mm512_store_pd(&out_im[7*K+k],ti); }
    }
}
...
#endif /* FFT_RADIX8_AVX512_DIF_TW_H */
