    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 1)
    {
        ...
        *(&out_re[1 * K + k]) = (A1r + t1r);
        *(&out_im[1 * K + k]) = (A1i + t1i);
        *(&out_re[5 * K + k]) = (A1r - t1r);
        *(&out_im[5 * K + k]) = (A1i - t1i);
        ...
        *(&out_re[3 * K + k]) = (A3r + t3r);
        *(&out_im[3 * K + k]) = (A3i + t3i);
        *(&out_re[7 * K + k]) = (A3r - t3r);
        *(&out_im[7 * K + k]) = (A3i - t3i);
    }
}
