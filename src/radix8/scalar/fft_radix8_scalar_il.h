/**
 * @file fft_radix8_scalar_il.h
 * @brief DFT-8 SCALAR codelets — interleaved + log3 twiddles
 * Generated by gen_r8_log3.py
 */
#ifndef FFT_RADIX8_SCALAR_IL_H
#define FFT_RADIX8_SCALAR_IL_H
#include <stddef.h>
