...
int main(void){
    ...
    for(int ki=0;ki<7;ki++){
        ...
        free64(ir);free64(ii);free64(ref_r);free64(ref_i);free64(out_r);free64(out_i);
        free64(pk_ir);free64(pk_ii);free64(pk_or);free64(pk_oi);free64(ftwr);free64(ftwi);
        if(pk_twr)free64(pk_twr); if(pk_twi)free64(pk_twi);
    }
    ...
    for(int ki=0;ki<7;ki++){
        ...
        free64(ir);free64(ii);free64(o1r);free64(o1i);free64(ftwr);free64(ftwi);
        free64(pk_ir);free64(pk_ii);free64(pk_or);free64(pk_oi);free64(pk_twr);free64(pk_twi);
    }
