        ...
        for which_side = 0 to 1 do
          ...
          for g = 0 to groups - 1 do
            ...
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m256d _t0_%s = _mm256_unpacklo_pd(_row_%s_0, \
                  _row_%s_1);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m256d _t1_%s = _mm256_unpackhi_pd(_row_%s_0, \
                  _row_%s_1);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m256d _t2_%s = _mm256_unpacklo_pd(_row_%s_2, \
                  _row_%s_3);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m256d _t3_%s = _mm256_unpackhi_pd(_row_%s_2, \
                  _row_%s_3);\n"
                 suf
                 suf
                 suf);
        ...
        for which_side = 0 to 1 do
          ...
          for g = 0 to groups - 1 do
            ...
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t0_%s = _mm512_unpacklo_pd(_row_%s_0, \
                  _row_%s_1);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t1_%s = _mm512_unpackhi_pd(_row_%s_0, \
                  _row_%s_1);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t2_%s = _mm512_unpacklo_pd(_row_%s_2, \
                  _row_%s_3);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t3_%s = _mm512_unpackhi_pd(_row_%s_2, \
                  _row_%s_3);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t4_%s = _mm512_unpacklo_pd(_row_%s_4, \
                  _row_%s_5);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t5_%s = _mm512_unpackhi_pd(_row_%s_4, \
                  _row_%s_5);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t6_%s = _mm512_unpacklo_pd(_row_%s_6, \
                  _row_%s_7);\n"
                 suf
                 suf
                 suf);
            Buffer.add_string
              buf
              (Printf.sprintf
                 "            const __m512d _t7_%s = _mm512_unpackhi_pd(_row_%s_6, \
                  _row_%s_7);\n"
                 suf
                 suf
                 suf);
