...
type abi = R2cb | Hc2hc_dif_bwd | Hc2hc_dif_bwd_log3 | Hc2hc_dif_rng_bwd | Unknown
...
let proto abi sym =
  ...
  | R2cb ->
    Printf.sprintf
      "extern void %s(const double*, const double*, double*, ptrdiff_t, ptrdiff_t, ptrdiff_t, size_t);"
      sym
...
let () =
  ...
  Arg.parse [ ("--isa", Arg.Set_string isa, "avx2|avx512") ]
    (fun _ -> ()) "emit_c2r_registry --isa <avx2|avx512>";
  let isa = !isa in
