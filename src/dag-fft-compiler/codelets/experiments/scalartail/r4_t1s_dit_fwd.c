 ...
 * Bulk full-vectors + scalar remainder tail. t1s twiddle is broadcast
 * (tw_re[leg]), lane-independent, so the tail needs no stride change.
 * Even-K (me%4==0) is byte-identical to the original.
 * ====================================================== */
#include <immintrin.h>
#include <stddef.h>
    ...
    size_t me)
{
    ...
    for (; k < me; k++) {  /* scalar (1-wide SSE) tail; broadcast tw is lane-independent */
