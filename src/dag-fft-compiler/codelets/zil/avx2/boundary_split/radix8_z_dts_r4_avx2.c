    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (size_t k = 0; k + 4 <= count; k += 4) {
        ...
        _mm256_storeu_pd(&zout[4*(size_t)k + 0], t129);
        _mm256_storeu_pd(&zout[4*(size_t)k + 4], t130);
        _mm256_storeu_pd(&zout[4*((size_t)2*OLs + k) + 0], t137);
        _mm256_storeu_pd(&zout[4*((size_t)2*OLs + k) + 4], t138);
        _mm256_storeu_pd(&zout[4*((size_t)1*OLs + k) + 0], t125);
        _mm256_storeu_pd(&zout[4*((size_t)1*OLs + k) + 4], t126);
        _mm256_storeu_pd(&zout[4*((size_t)3*OLs + k) + 0], t135);
        _mm256_storeu_pd(&zout[4*((size_t)3*OLs + k) + 4], t136);
        _mm256_storeu_pd(&zout[4*(size_t)k + 8], t120);
        _mm256_storeu_pd(&zout[4*(size_t)k + 12], t122);
        _mm256_storeu_pd(&zout[4*((size_t)2*OLs + k) + 8], t133);
        _mm256_storeu_pd(&zout[4*((size_t)2*OLs + k) + 12], t134);
        _mm256_storeu_pd(&zout[4*((size_t)1*OLs + k) + 8], t99);
        _mm256_storeu_pd(&zout[4*((size_t)1*OLs + k) + 12], t100);
        _mm256_storeu_pd(&zout[4*((size_t)3*OLs + k) + 8], t131);
        _mm256_storeu_pd(&zout[4*((size_t)3*OLs + k) + 12], t132);
    }
}
