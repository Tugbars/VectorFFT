...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 8 --zp-stfu --zp-r0 4 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stfu radix=8 dir=fwd isa=avx2 r0=4 (ZTURN-S sectioned geometry)
...
void radix8_z_stfu_r4_fwd_avx2(
