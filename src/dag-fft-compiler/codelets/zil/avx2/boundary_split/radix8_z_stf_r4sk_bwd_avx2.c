...
/* ===================== PROVENANCE =====================
 * Generated by: ./_build/default/bin/gen_radix.exe 8 --zp-stfb --zp-r0 4 --zp-sink --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stf radix=8 dir=bwd isa=avx2 r0=4 (ZTURN-S sectioned geometry) sink-stores (store-at-def interleave, --zp-sink)
...
void radix8_z_stf_r4sk_bwd_avx2(
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (size_t k = 0; k + 4 <= count; k += 4) {
        ...
        /* SU-scheduled body (pipeline) + sect-tap stores sunk at defs */
