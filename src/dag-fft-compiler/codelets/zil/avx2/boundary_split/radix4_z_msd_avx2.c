...
/* ===================== PROVENANCE =====================
 * Generated by: /mnt/c/Users/Tugbars/Desktop/highSpeedFFT/src/dag-fft-compiler/generator/_build/default/bin/gen_radix.exe 4 --zp-msd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=msd radix=4 dir=fwd isa=avx2
    ...
    const double *tw_re, size_t Ls, size_t count)
{
    for (size_t k = 0; k + 4 <= count; k += 4) {
        ...
        const __m256d t28 = _mm256_loadu_pd(&tw_re[0]);
        const __m256d t30 = _mm256_loadu_pd(&tw_re[4]);
        ...
        const __m256d t35 = _mm256_loadu_pd(&tw_re[8]);
        ...
        const __m256d t42 = _mm256_loadu_pd(&tw_re[16]);
