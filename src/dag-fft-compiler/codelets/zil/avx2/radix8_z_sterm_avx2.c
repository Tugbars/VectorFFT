 ...
 * sterm (SPLIT-INPUT terminator: TR4 loads, packed w^1 squaring tree, REINT drev-comb stores), fwd.
...
/* ===================== PROVENANCE =====================
 * Generated by: ./_build/default/bin/gen_radix.exe 8 --zp-sterm --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=sterm radix=8 dir=fwd isa=avx2
