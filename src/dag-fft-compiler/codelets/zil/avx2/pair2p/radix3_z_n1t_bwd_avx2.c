/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 3 --cil-n1t --cil-bwd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: full-IL (interleaved-complex) n1t, radix-3 bwd
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (; k < count; ++k) {
        ...
        _mm_storeu_pd(&zout[2*((size_t)k*OLs + 1)], z9);
