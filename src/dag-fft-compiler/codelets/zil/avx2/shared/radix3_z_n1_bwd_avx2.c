/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 3 --cil-n1 --cil-bwd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: full-IL (interleaved-complex) n1, radix-3 bwd
 ...
 * radix-3 solo n1 (natural order in/out, twiddle-free): 2 complex per 256-bit vector. Body scheduled by the
