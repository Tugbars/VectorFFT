...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 8 --zp-tlfi --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=tlfi radix=8 dir=fwd isa=avx2
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (size_t g = 0; g < Gs; g++) {
        _ztlfi8f_body(ip, op, tw_re, Ls, OLs, count);
        ip += 2 * (size_t)8 * Ls;
        op += 2 * (size_t)8 * OLs;
    }
}
