...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-tmg --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=tmg radix=4 dir=fwd isa=avx2
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (size_t g = 0; g < Gs; g++) {
        _ztmg4f_body(bp, bp, twg, Ls, count);
        bp += 2 * (size_t)4 * Ls;
