/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 10 --cil-t2 --cil-turnst --cil-bwd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (; k + 2 <= count; k += 2) {
        ...
        _mm256_storeu_pd(&zout[2*((size_t)k*OLs + 0)], _mm256_permute2f128_pd(z47, z60, 0x20));
        _mm256_storeu_pd(&zout[2*(((size_t)k + 1)*OLs + 0)], _mm256_permute2f128_pd(z47, z60, 0x31));
        ...
        _mm256_storeu_pd(&zout[2*((size_t)k*OLs + 8)], _mm256_permute2f128_pd(z67, z68, 0x20));
        _mm256_storeu_pd(&zout[2*(((size_t)k + 1)*OLs + 8)], _mm256_permute2f128_pd(z67, z68, 0x31));
    }
    ...
    for (; k < count; ++k) {
        ...
        _mm_storeu_pd(&zout[2*((size_t)k*OLs + 9)], z68);
    }
}
