/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 3 --cil-t2 --cil-log3 --cil-bwd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
...
void radix3_z_t2_log3_bwd_avx2(
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (; k + 2 <= count; k += 2) {
        ...
        /* log3: 2 of 2 VTW2 records loaded, 0 derived */
