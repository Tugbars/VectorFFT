/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 2 --cil-n1c --cil-bwd --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 ...
 * radix-2 2D column-stage leaf n1c (n1 math; count = adjacent plane columns, in-place same-slot): 2 complex per 256-bit vector. Body scheduled by the
