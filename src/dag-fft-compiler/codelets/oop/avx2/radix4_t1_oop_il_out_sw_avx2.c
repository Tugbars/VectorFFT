/* ===================== PROVENANCE =====================
 * Generated by: /mnt/c/Users/Tugbars/Desktop/highSpeedFFT/src/dag-fft-compiler/generator/_build/default/bin/gen_radix.exe 4 --oop --oop-buffer-oop --oop-load UG --oop-store UG --isa avx2 --twiddled --oop-il-out-sw --emit-c
 * Env overrides: (none)
...
void radix4_t1_oop_fwd_avx2_UG_UG_il_out_sw(
