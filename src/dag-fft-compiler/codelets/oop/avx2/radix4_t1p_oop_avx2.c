    ...
    for (size_t b = 0; b < me; b += 4) {
        ...
        /* === BUTTERFLY BODY (monolithic) ===
           Tier A: algsimp cascade + inline + fence, single scope. */
                ...
                const __m256d t1 = _mm256_set1_pd(tw_re[2*(me/4) + b/4]);
                const __m256d t2 = lane_im_3;
                const __m256d t3 = _mm256_set1_pd(tw_im[2*(me/4) + b/4]);
                ...
                const __m256d t12 = _mm256_set1_pd(tw_im[0*(me/4) + b/4]);
                ...
                const __m256d t22 = _mm256_set1_pd(tw_re[1*(me/4) + b/4]);
                const __m256d t23 = lane_im_2;
                const __m256d t24 = _mm256_set1_pd(tw_im[1*(me/4) + b/4]);
