...
# Outputs (gitignored): generated/jit/codelets_linux/*.o + generated/jit/codelets_linux.rsp
set -e
GCC="${GCC:-gcc}"
JIT="$(cd "$(dirname "$0")" && pwd)"
ROOT="$(dirname "$JIT")"
SRC="$ROOT/codelets/inplace/avx2"
OUT="$ROOT/generated/jit/codelets_linux"
RSP="$ROOT/generated/jit/codelets_linux.rsp"
mkdir -p "$OUT"
