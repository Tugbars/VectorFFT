/* auto-generated K=1 JIT wrapper — k1_n2048_r3_64x32_avx2_ver3. Shape baked, buffers passed. */
...
{
    radix32_n1_oop_fwd_avx2_UG_UG(sr, si, cr, ci, 0, 0, 64, 1, 64, 1, 64);
}
...
{
    radix64_t1_oop_fwd_avx2_UL_UG_twl(cr, ci, dr, di, qr, qi, 1, 64, 32, 1, 32);
}
