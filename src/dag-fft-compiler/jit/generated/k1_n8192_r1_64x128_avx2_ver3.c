/* auto-generated K=1 JIT wrapper — k1_n8192_r1_64x128_avx2_ver3. Shape baked, buffers passed. */
...
{
    radix128_n1_oop_fwd_avx2_UG_UG(sr, si, cr, ci, 0, 0, 64, 1, 64, 1, 64);
}
...
{
    radix64_t1_oop_fwd_avx2_UL_UG(cr, ci, dr, di, qr, qi, 1, 64, 128, 1, 128);
}
