 ...
 * @brief DFT-64 AVX2 t1 DIT buffered (TILE=32, drain=stream, prefw=True) -- NFUSE=0
 *
...
radix64_t1_buf_dit_tile32_stream_prefw_fwd_avx2(
    ...
    size_t ios, size_t me)
{
    ...
    __attribute__((aligned(32))) double outbuf_re[64*32];
    __attribute__((aligned(32))) double outbuf_im[64*32];
...
static __attribute__((target("avx2,fma"))) void
radix64_t1_buf_dit_tile32_stream_prefw_bwd_avx2(
    double * __restrict__ rio_re, double * __restrict__ rio_im,
    const double * __restrict__ W_re, const double * __restrict__ W_im,
    size_t ios, size_t me)
{
