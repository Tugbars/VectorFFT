/**
 * @file fft_radix64_avx2_ct_t1_dit_prefetch.h
 * @brief DFT-64 AVX2 t1 DIT with prefetch (in-place twiddle) -- NFUSE=0
 *
 * FFTW-style codelet for recursive CT executor.
 * Generated by gen_radix64.py --variant ct_t1_dit_prefetch
 */

#ifndef FFT_RADIX64_AVX2_CT_CT_T1_DIT_PREFETCH_H
#define FFT_RADIX64_AVX2_CT_CT_T1_DIT_PREFETCH_H
...
radix64_t1_dit_prefetch_fwd_avx2(
    ...
    size_t ios, size_t me)
{
    ...
    for (size_t m = 0; m < me; m += 4) {
        ...
        if (m + 4 < me) {
            _mm_prefetch((const char*)&W_re[0*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[0*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[2*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[2*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[4*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[4*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[6*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[6*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[8*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[8*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[10*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[10*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[12*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[12*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[14*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[14*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[16*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[16*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[18*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[18*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[20*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[20*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[22*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[22*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[24*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[24*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[26*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[26*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[28*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[28*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[30*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[30*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[32*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[32*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[34*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[34*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[36*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[36*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[38*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[38*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[40*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[40*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[42*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[42*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[44*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[44*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[46*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[46*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[48*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[48*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[50*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[50*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[52*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[52*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[54*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[54*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[56*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[56*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[58*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[58*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[60*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[60*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_re[62*me+m+4], _MM_HINT_T0);
            _mm_prefetch((const char*)&W_im[62*me+m+4], _MM_HINT_T0);
        }
        /* sub-FFT n2=0 */
...
static __attribute__((target("avx2,fma"))) void
radix64_t1_dit_prefetch_bwd_avx2(
    double * __restrict__ rio_re, double * __restrict__ rio_im,
    const double * __restrict__ W_re, const double * __restrict__ W_im,
    size_t ios, size_t me)
{
...
#endif /* FFT_RADIX64_AVX2_CT_CT_T1_DIT_PREFETCH_H */
