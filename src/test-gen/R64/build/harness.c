...
extern void radix64_t1_dit_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dif_fwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dif_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_log3_fwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_log3_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_prefetch_fwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
...
extern void radix64_t1_dif_bwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_log3_fwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_log3_bwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix64_t1_dit_prefetch_fwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
...
static cand_t CANDS[] = {
    {"ct_t1_dit__avx2", "avx2", radix64_t1_dit_fwd_avx2, radix64_t1_dit_bwd_avx2, 0},
    {"ct_t1_dif__avx2", "avx2", radix64_t1_dif_fwd_avx2, radix64_t1_dif_bwd_avx2, 0},
