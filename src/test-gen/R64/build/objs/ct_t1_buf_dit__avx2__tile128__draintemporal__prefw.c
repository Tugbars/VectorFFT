 ...
 * @brief DFT-64 AVX2 t1 DIT buffered (TILE=128, drain=temporal, prefw=True) -- NFUSE=0
 *
...
radix64_t1_buf_dit_tile128_temporal_prefw_fwd_avx2(
...
__attribute__((target("avx2,fma"))) void
radix64_t1_buf_dit_tile128_temporal_prefw_bwd_avx2(
    double * __restrict__ rio_re, double * __restrict__ rio_im,
    const double * __restrict__ W_re, const double * __restrict__ W_im,
    size_t ios, size_t me)
{
