"""
run_r64_bench.py — full R=64 bench with parallel compile and incremental
...
Usage:
    python run_r64_bench.py --phase generate
    python run_r64_bench.py --phase build
    python run_r64_bench.py --phase run  (can be resumed)
"""
...
if __name__ == '__main__':
    ...
    cc = os.environ.get('CC', 'gcc')
    print("-" * 64)
    print(" VectorFFT codelet bench (R=64)")
    print("-" * 64)
