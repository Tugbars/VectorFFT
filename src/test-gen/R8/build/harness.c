...
extern void radix8_t1_dit_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dif_fwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dif_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_prefetch_fwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_prefetch_bwd_avx2(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_fwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_bwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dif_fwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dif_bwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_prefetch_fwd_avx512(double*, double*, const double*, const double*, size_t, size_t);
extern void radix8_t1_dit_prefetch_bwd_avx512(double*, double*, const double*, const double*, size_t, size_t);

typedef struct { const char *id; const char *isa; t1_fn fwd, bwd; int req512; } cand_t;
static cand_t CANDS[] = {
    {"ct_t1_dit__avx2", "avx2", radix8_t1_dit_fwd_avx2, radix8_t1_dit_bwd_avx2, 0},
    {"ct_t1_dif__avx2", "avx2", radix8_t1_dif_fwd_avx2, radix8_t1_dif_bwd_avx2, 0},
    {"ct_t1_dit_prefetch__avx2", "avx2", radix8_t1_dit_prefetch_fwd_avx2, radix8_t1_dit_prefetch_bwd_avx2, 0},
    {"ct_t1_dit__avx512", "avx512", radix8_t1_dit_fwd_avx512, radix8_t1_dit_bwd_avx512, 1},
    {"ct_t1_dif__avx512", "avx512", radix8_t1_dif_fwd_avx512, radix8_t1_dif_bwd_avx512, 1},
    {"ct_t1_dit_prefetch__avx512", "avx512", radix8_t1_dit_prefetch_fwd_avx512, radix8_t1_dit_prefetch_bwd_avx512, 1},
