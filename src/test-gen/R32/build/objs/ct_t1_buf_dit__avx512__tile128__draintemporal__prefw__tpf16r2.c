 ...
 * @brief DFT-32 AVX512 t1 DIT buffered (TILE=128, drain=temporal, prefw=True, tpf=16) � NFUSE=4
 *
 * FFTW-style codelet for recursive CT executor.
 * Generated by gen_radix32.py --variant ct_t1_buf_dit
 */

#ifndef FFT_RADIX32_AVX512_CT_T1_BUF_DIT_TILE128_TEMPORAL_PREFW_TPF16R2_H
#define FFT_RADIX32_AVX512_CT_T1_BUF_DIT_TILE128_TEMPORAL_PREFW_TPF16R2_H
...
radix32_t1_buf_dit_tile128_temporal_prefw_tpf16r2_fwd_avx512(
...
__attribute__((target("avx512f,avx512dq,fma"))) void
radix32_t1_buf_dit_tile128_temporal_prefw_tpf16r2_bwd_avx512(
    double * __restrict__ rio_re, double * __restrict__ rio_im,
    const double * __restrict__ W_re, const double * __restrict__ W_im,
    size_t ios, size_t me)
{
...
#endif /* FFT_RADIX32_AVX512_CT_T1_BUF_DIT_TILE128_TEMPORAL_PREFW_TPF16R2_H */
