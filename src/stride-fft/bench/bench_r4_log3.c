...
int main(void) {
    ...
    /* N values with multiple R=4 stages */
    test_n_t test_Ns[] = {
        {256},       /* 4x4x4x4 — pure R=4 */
        {1024},      /* 4x4x4x4x4 or 4x4x64 etc */
        {4096},      /* many R=4 stages */
        {16384},     /* deep R=4 chain */
        {64},        /* 4x4x4 — small */
        {16},        /* 4x4 — tiny */
        {1000},      /* composite with R=4 stages */
        {4000},      /* composite */
        {16000},     /* composite */
    };
