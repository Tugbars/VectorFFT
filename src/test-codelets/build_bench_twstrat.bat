...
echo.
echo VectorFFT Twiddle Strategy Benchmark
echo.
...
echo Compiling...
%CC% %CFLAGS% -I"%HDR_DIR%" -I"%FFTW_INC%" -I"%SCRIPT_DIR%." -o "%BUILD_DIR%\bench_twiddle_strategy.exe" "%SCRIPT_DIR%bench_twiddle_strategy.c" "%FFTW_LIB%"
...
echo Running...
echo.
"%BUILD_DIR%\bench_twiddle_strategy.exe"
endlocal
