...
echo.
echo VectorFFT Auto-Planned FFT Benchmark
echo.
...
echo Compiling...
icx -O3 -march=native -mavx2 -mfma -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -I%HDR_DIR% -I%FFTW_INC% -I%CODELET_DIR% -I%PLANNER_DIR% -o %BUILD_DIR%\bench_planner.exe %PLANNER_DIR%bench_planner.c %FFTW_LIB%
