 ...
 *
 * Factorizes N using the greedy heuristic, selects flat/log3 per stage,
 * builds and returns a plan. No benchmarking.
 *
 * Returns NULL if N cannot be factored into available radixes.
 */
