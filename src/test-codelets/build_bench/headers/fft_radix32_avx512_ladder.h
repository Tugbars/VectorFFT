 ...
 * @brief DFT-32 AVX512 ladder (log-derived) twiddles, NFUSE=4
 *
 ...
 *   ──────────────────── ───── ───── ───── ───── ───── ───── + ───── ───── + ─── ─── ─── ─── ────
 *   ladder_dif_u1_bwd      172   172   170    11    73    73 |   671   817 |  64  64  28  28  184
 *   ladder_dif_u1_fwd      172   172   170    11    73    73 |   671   817 |  64  64  28  28  184
 *   ladder_u1_bwd          172   172   194    11    85    85 |   719   889 |  64  64  28  28  184
 *   ladder_u1_fwd          172   172   194    11    85    85 |   719   889 |  64  64  28  28  184
 *   ladder_u2_bwd          344   344   388    22   170   170 |  1438  1778 | 128 128  56  56  368
 *   ladder_u2_fwd          344   344   388    22   170   170 |  1438  1778 | 128 128  56  56  368
 *
 */
    ...
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 8)
  {
    ...
    const __m512d b1_re = LD(&base_tw_re[0 * K + k]);
    const __m512d b1_im = LD(&base_tw_im[0 * K + k]);
    const __m512d b2_re = LD(&base_tw_re[1 * K + k]);
    const __m512d b2_im = LD(&base_tw_im[1 * K + k]);
    const __m512d b4_re = LD(&base_tw_re[2 * K + k]);
    const __m512d b4_im = LD(&base_tw_im[2 * K + k]);
    const __m512d b8_re = LD(&base_tw_re[3 * K + k]);
    const __m512d b8_im = LD(&base_tw_im[3 * K + k]);
    const __m512d b16_re = LD(&base_tw_re[4 * K + k]);
    const __m512d b16_im = LD(&base_tw_im[4 * K + k]);
...
/* === DIF LADDER U=1 (AVX512, NFUSE=4) === */

static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_ladder_dif_kernel_fwd_avx512_u1(
    const double *__restrict__ in_re, const double *__restrict__ in_im,
    double *__restrict__ out_re, double *__restrict__ out_im,
    const double *__restrict__ base_tw_re, const double *__restrict__ base_tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 8)
  {
    ...
    __m512d w7_re, w7_im;
    w7_re = _mm512_fmsub_pd(b3_re, b4_re, _mm512_mul_pd(b3_im, b4_im));
    w7_im = _mm512_fmadd_pd(b3_re, b4_im, _mm512_mul_pd(b3_im, b4_re));
    __m512d b24_re, b24_im;
    b24_re = _mm512_fmsub_pd(b8_re, b16_re, _mm512_mul_pd(b8_im, b16_im));
    b24_im = _mm512_fmadd_pd(b8_re, b16_im, _mm512_mul_pd(b8_im, b16_re));
    __m512d tw_re, tw_im;
    ...
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, b24_re, _mm512_mul_pd(x3_im, b24_im));
      x3_im = _mm512_fmadd_pd(tr, b24_im, _mm512_mul_pd(x3_im, b24_re));
    }
    ...
    tw_re = _mm512_fmsub_pd(b1_re, b8_re, _mm512_mul_pd(b1_im, b8_im));
    tw_im = _mm512_fmadd_pd(b1_re, b8_im, _mm512_mul_pd(b1_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b1_re, b16_re, _mm512_mul_pd(b1_im, b16_im));
    tw_im = _mm512_fmadd_pd(b1_re, b16_im, _mm512_mul_pd(b1_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b1_re, b24_re, _mm512_mul_pd(b1_im, b24_im));
    tw_im = _mm512_fmadd_pd(b1_re, b24_im, _mm512_mul_pd(b1_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    }
    ...
    tw_re = _mm512_fmsub_pd(b2_re, b8_re, _mm512_mul_pd(b2_im, b8_im));
    tw_im = _mm512_fmadd_pd(b2_re, b8_im, _mm512_mul_pd(b2_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b2_re, b16_re, _mm512_mul_pd(b2_im, b16_im));
    tw_im = _mm512_fmadd_pd(b2_re, b16_im, _mm512_mul_pd(b2_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b2_re, b24_re, _mm512_mul_pd(b2_im, b24_im));
    tw_im = _mm512_fmadd_pd(b2_re, b24_im, _mm512_mul_pd(b2_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    ...
    tw_re = _mm512_fmsub_pd(b3_re, b8_re, _mm512_mul_pd(b3_im, b8_im));
    tw_im = _mm512_fmadd_pd(b3_re, b8_im, _mm512_mul_pd(b3_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b3_re, b16_re, _mm512_mul_pd(b3_im, b16_im));
    tw_im = _mm512_fmadd_pd(b3_re, b16_im, _mm512_mul_pd(b3_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b3_re, b24_re, _mm512_mul_pd(b3_im, b24_im));
    tw_im = _mm512_fmadd_pd(b3_re, b24_im, _mm512_mul_pd(b3_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    ...
    tw_re = _mm512_fmsub_pd(b4_re, b8_re, _mm512_mul_pd(b4_im, b8_im));
    tw_im = _mm512_fmadd_pd(b4_re, b8_im, _mm512_mul_pd(b4_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b4_re, b16_re, _mm512_mul_pd(b4_im, b16_im));
    tw_im = _mm512_fmadd_pd(b4_re, b16_im, _mm512_mul_pd(b4_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(b4_re, b24_re, _mm512_mul_pd(b4_im, b24_im));
    tw_im = _mm512_fmadd_pd(b4_re, b24_im, _mm512_mul_pd(b4_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    ...
    tw_re = _mm512_fmsub_pd(w5_re, b8_re, _mm512_mul_pd(w5_im, b8_im));
    tw_im = _mm512_fmadd_pd(w5_re, b8_im, _mm512_mul_pd(w5_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w5_re, b16_re, _mm512_mul_pd(w5_im, b16_im));
    tw_im = _mm512_fmadd_pd(w5_re, b16_im, _mm512_mul_pd(w5_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w5_re, b24_re, _mm512_mul_pd(w5_im, b24_im));
    tw_im = _mm512_fmadd_pd(w5_re, b24_im, _mm512_mul_pd(w5_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    ...
    tw_re = _mm512_fmsub_pd(w6_re, b8_re, _mm512_mul_pd(w6_im, b8_im));
    tw_im = _mm512_fmadd_pd(w6_re, b8_im, _mm512_mul_pd(w6_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w6_re, b16_re, _mm512_mul_pd(w6_im, b16_im));
    tw_im = _mm512_fmadd_pd(w6_re, b16_im, _mm512_mul_pd(w6_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w6_re, b24_re, _mm512_mul_pd(w6_im, b24_im));
    tw_im = _mm512_fmadd_pd(w6_re, b24_im, _mm512_mul_pd(w6_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
    ...
    tw_re = _mm512_fmsub_pd(w7_re, b8_re, _mm512_mul_pd(w7_im, b8_im));
    tw_im = _mm512_fmadd_pd(w7_re, b8_im, _mm512_mul_pd(w7_im, b8_re));
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmsub_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x1_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w7_re, b16_re, _mm512_mul_pd(w7_im, b16_im));
    tw_im = _mm512_fmadd_pd(w7_re, b16_im, _mm512_mul_pd(w7_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmsub_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x2_im, tw_re));
    }
    tw_re = _mm512_fmsub_pd(w7_re, b24_re, _mm512_mul_pd(w7_im, b24_im));
    tw_im = _mm512_fmadd_pd(w7_re, b24_im, _mm512_mul_pd(w7_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmsub_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmadd_pd(tr, tw_im, _mm512_mul_pd(x3_im, tw_re));
...
static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_ladder_dif_kernel_bwd_avx512_u1(
    const double *__restrict__ in_re, const double *__restrict__ in_im,
    double *__restrict__ out_re, double *__restrict__ out_im,
    const double *__restrict__ base_tw_re, const double *__restrict__ base_tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 8)
  {
    ...
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmadd_pd(x3_re, b24_re, _mm512_mul_pd(x3_im, b24_im));
      x3_im = _mm512_fmsub_pd(x3_im, b24_re, _mm512_mul_pd(tr, b24_im));
    }
    ...
    {
      __m512d tr = x1_re;
      x1_re = _mm512_fmadd_pd(x1_re, tw_re, _mm512_mul_pd(x1_im, tw_im));
      x1_im = _mm512_fmsub_pd(x1_im, tw_re, _mm512_mul_pd(tr, tw_im));
    }
    tw_re = _mm512_fmsub_pd(b1_re, b16_re, _mm512_mul_pd(b1_im, b16_im));
    tw_im = _mm512_fmadd_pd(b1_re, b16_im, _mm512_mul_pd(b1_im, b16_re));
    {
      __m512d tr = x2_re;
      x2_re = _mm512_fmadd_pd(x2_re, tw_re, _mm512_mul_pd(x2_im, tw_im));
      x2_im = _mm512_fmsub_pd(x2_im, tw_re, _mm512_mul_pd(tr, tw_im));
    }
    tw_re = _mm512_fmsub_pd(b1_re, b24_re, _mm512_mul_pd(b1_im, b24_im));
    tw_im = _mm512_fmadd_pd(b1_re, b24_im, _mm512_mul_pd(b1_im, b24_re));
    {
      __m512d tr = x3_re;
      x3_re = _mm512_fmadd_pd(x3_re, tw_re, _mm512_mul_pd(x3_im, tw_im));
      x3_im = _mm512_fmsub_pd(x3_im, tw_re, _mm512_mul_pd(tr, tw_im));
    }
    ...
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 16)
  {
    ...
    const __m512d A_b1_re = LD(&base_tw_re[0 * K + k]);
    const __m512d A_b1_im = LD(&base_tw_im[0 * K + k]);
    const __m512d A_b2_re = LD(&base_tw_re[1 * K + k]);
    const __m512d A_b2_im = LD(&base_tw_im[1 * K + k]);
    const __m512d A_b4_re = LD(&base_tw_re[2 * K + k]);
    const __m512d A_b4_im = LD(&base_tw_im[2 * K + k]);
    const __m512d A_b8_re = LD(&base_tw_re[3 * K + k]);
    const __m512d A_b8_im = LD(&base_tw_im[3 * K + k]);
    const __m512d A_b16_re = LD(&base_tw_re[4 * K + k]);
    const __m512d A_b16_im = LD(&base_tw_im[4 * K + k]);
    ...
    const __m512d B_b1_re = LD(&base_tw_re[0 * K + k + 8]);
    const __m512d B_b1_im = LD(&base_tw_im[0 * K + k + 8]);
    const __m512d B_b2_re = LD(&base_tw_re[1 * K + k + 8]);
    const __m512d B_b2_im = LD(&base_tw_im[1 * K + k + 8]);
    const __m512d B_b4_re = LD(&base_tw_re[2 * K + k + 8]);
    const __m512d B_b4_im = LD(&base_tw_im[2 * K + k + 8]);
    const __m512d B_b8_re = LD(&base_tw_re[3 * K + k + 8]);
    const __m512d B_b8_im = LD(&base_tw_im[3 * K + k + 8]);
    const __m512d B_b16_re = LD(&base_tw_re[4 * K + k + 8]);
    const __m512d B_b16_im = LD(&base_tw_im[4 * K + k + 8]);
