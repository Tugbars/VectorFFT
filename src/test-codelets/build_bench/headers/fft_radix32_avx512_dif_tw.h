 ...
 * @brief DFT-32 AVX512 DIF twiddled codelet — flat twiddles, NFUSE=4
 *
 ...
 *   ──────────────────── ───── ───── ───── ───── ───── ───── + ───── ───── + ─── ─── ─── ─── ────
 *   bwd                    172   172   118    11    47    47 |   567   661 |  64  64  28  28  184
 *   fwd                    172   172   118    11    47    47 |   567   661 |  64  64  28  28  184
 *
 */
...
#ifndef R32DL_LD
#define R32DL_LD(p) _mm512_loadu_pd(p)
#endif
#ifndef R32DL_ST
#define R32DL_ST(p,v) _mm512_storeu_pd((p),(v))
#endif
#define LD R32DL_LD
#define ST R32DL_ST

/* === DIF FLAT (AVX512, NFUSE=4) === */
