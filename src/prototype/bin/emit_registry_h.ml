...
let emit_header_file ~isa =
  print_endline "/* registry.h — auto-generated by bin/emit_registry_h.ml.";
  print_endline " * DO NOT EDIT BY HAND. Regenerate via:";
  print_endline " *   dune exec bin/emit_registry_h.exe -- --isa <isa> \\";
  print_endline " *     > generated/registry.h";
  print_endline " *";
  print_endline " * Prototype codelet registry. Function-pointer table indexed by";
  print_endline " * radix, one slot per (kind × orient × log3? × direction). Codelets";
  print_endline " * that aren't emitted for a given radix leave their slots NULL.";
  print_endline " *";
  print_endline " * Namespaced as vfft_proto_* so it coexists with production's";
  print_endline " * src/core/registry.h. When prototype replaces production, drop";
  print_endline " * the namespace. */";
  print_endline "#ifndef VFFT_PROTO_REGISTRY_H";
  print_endline "#define VFFT_PROTO_REGISTRY_H";
  print_endline "";
  ...
  emit_helpers ();
  print_endline "";
  print_endline "#endif /* VFFT_PROTO_REGISTRY_H */"
