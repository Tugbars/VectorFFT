/* registry.h — auto-generated by bin/emit_registry_h.ml.
 * DO NOT EDIT BY HAND. Regenerate via:
 *   dune exec bin/emit_registry_h.exe -- --isa <isa> \
 *     > generated/registry.h
 *
 * Prototype codelet registry. Function-pointer table indexed by
 * radix, one slot per (kind × orient × log3? × direction). Codelets
 * that aren't emitted for a given radix leave their slots NULL.
 *
 * Namespaced as vfft_proto_* so it coexists with production's
 * src/core/registry.h. When prototype replaces production, drop
 * the namespace. */
