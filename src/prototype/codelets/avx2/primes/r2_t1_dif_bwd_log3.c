...
void radix2_t1_dif_log3_bwd_avx2_gen_inplace(
    ...
    size_t me)
{
    for (size_t k = 0; k < me; k += 4) {
        ...
        register __m256d t16 asm("ymm3") = _mm256_fmadd_pd(t10, t11, _mm256_mul_pd(t13, t14)); asm volatile ("" : "+v"(t16));
        register __m256d t17 asm("ymm7") = _mm256_fnmadd_pd(t10, t14, _mm256_mul_pd(t13, t11)); asm volatile ("" : "+v"(t17));
