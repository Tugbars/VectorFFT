/* bench_r64_dif_bwd.c — R=64 DIF in-place bwd: hand vs ours (recipe). */
...
static void hand_bwd(double *r, double *i, const double *tr, const double *ti,
    ...
    radix64_t1_dif_bwd_avx512(r, i, tr, ti, ios, me);
}
...
static void cSU(){radix64_t1_dif_bwd_avx512_gen_inplace_su_spill(bSU_r,bSU_i,twr,twi,K,K);}
...
int main(int c,char**v){
    ...
    printf("R=64 DIF bwd K=%5zu  H=%9.0f SU=%9.0f | SU/H=%.3f\n", K,tH,tSU,tSU/tH);
    return 0;
}
