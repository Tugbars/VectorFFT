...
__attribute__((target("avx512f")))
void radix8_t1_dit_fwd_avx512_gen_inplace_su_spill(double*,double*,const double*,const double*,size_t,size_t);
...
static void cT(){radix8_t1_dit_fwd_avx512_gen_inplace(bT_r,bT_i,twr,twi,K,K);}
static void cSU(){radix8_t1_dit_fwd_avx512_gen_inplace_su_spill(bSU_r,bSU_i,twr,twi,K,K);}
