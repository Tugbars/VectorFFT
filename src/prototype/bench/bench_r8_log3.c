 ...
 *   B) gen_t1_dit   — generated radix8_t1_dit_log3_fwd_avx512 (in-place)
 *
...
static void call_generated(void) {
    radix8_t1_dit_log3_fwd_avx512(g_rio_re_gen, g_rio_im_gen,
                                          g_tw_re, g_tw_im,
                                          g_K, g_K);
}
...
int main(int argc, char **argv) {
    ...
    radix8_t1_dit_log3_fwd_avx512(g_rio_re_gen, g_rio_im_gen, g_tw_re, g_tw_im, K, K);
