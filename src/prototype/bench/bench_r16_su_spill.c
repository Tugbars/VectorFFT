...
static void cT(){radix16_t1_dit_fwd_avx512(bT_r,bT_i,twr,twi,K,K);}
static void cS(){radix16_t1_dit_fwd_avx512_spill(bS_r,bS_i,twr,twi,K,K);}
static void cSU(){radix16_t1_dit_fwd_avx512(bSU_r,bSU_i,twr,twi,K,K);}
