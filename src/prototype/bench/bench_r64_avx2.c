/* bench_r64_avx2.c — Topo vs SU+Spill on R=64 AVX2. */
...
void radix64_t1_dit_fwd_avx2_gen_inplace(double*,double*,const double*,const double*,size_t,size_t);
...
static void cT(){radix64_t1_dit_fwd_avx2_gen_inplace(bT_r,bT_i,twr,twi,K,K);}
static void cSU(){radix64_t1_dit_fwd_avx2_gen_inplace_su_spill(bSU_r,bSU_i,twr,twi,K,K);}
...
int main(int c,char**v){
    ...
    printf("K=%5zu  T=%9.0f SU=%9.0f | SU/T=%.3f\n", K,tT,tSU,tSU/tT);
    return 0;
}
