...
void radix64_t1_dit_fwd_avx2(double*,double*,const double*,const double*,size_t,size_t);
...
static void cT(){radix64_t1_dit_fwd_avx2(bT_r,bT_i,twr,twi,K,K);}
static void cSU(){radix64_t1_dit_fwd_avx2(bSU_r,bSU_i,twr,twi,K,K);}
