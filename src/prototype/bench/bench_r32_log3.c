...
__attribute__((target("avx512f")))
void radix32_t1_dit_log3_fwd_avx512_gen_inplace(double*,double*,const double*,const double*,size_t,size_t);
__attribute__((target("avx512f")))
...
static void cF(){radix32_t1_dit_fwd_avx512_gen_inplace(bF_r,bF_i,twr,twi,K,K);}
static void cL(){radix32_t1_dit_log3_fwd_avx512_gen_inplace(bL_r,bL_i,twr,twi,K,K);}
