...
__attribute__((target("avx512f")))
void radix16_t1_dit_fwd_avx512_gen_inplace_su(
    double * __restrict__, double * __restrict__,
    const double * __restrict__, const double * __restrict__,
    size_t, size_t);
...
static void cT(void) { radix16_t1_dit_fwd_avx512_gen_inplace(g_rio_re_t, g_rio_im_t, g_tw_re, g_tw_im, g_K, g_K); }
static void cS(void) { radix16_t1_dit_fwd_avx512_gen_inplace_su(g_rio_re_s, g_rio_im_s, g_tw_re, g_tw_im, g_K, g_K); }
