#!/bin/bash
# Runtime correctness test for all 8 R={5,7,11} codelet variants vs
# brute-force scalar DFT. Exercises the full DIT/DIF × Flat/Log3 ×
...
# Generate all 8 variants × 4 radixes = 32 codelet .c files
for R in 2 5 7 11; do
