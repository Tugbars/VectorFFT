 ...
 * DIT tw:  x'[n] = x[n] * W^(n*k), then DFT-13(x')
 * DIF tw:  y = IDFT-13(x), then y'[n] = y[n] * conj(W^(n*k))
 * Twiddle layout: tw_re[(n-1)*K + k], tw_im[(n-1)*K + k] for n=1..12.
 * ═══════════════════════════════════════════════════════════════ */

/* ── Scalar tw ── */
static void radix13_genfft_tw_fwd_scalar(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  const double KP2_000000000 = +2.000000000000000000000000000000000000000000000;
  const double KP083333333 = +0.083333333333333333333333333333333333333333333;
  ...
  for (size_t k = 0; k < K; k += 1)
  {
    ...
    { /* tw[8] */
      ...
      T1_re = (_xr * _wr - (_xi * _wi));
      T1_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[5] */
    ...
    double Tk_re, Tk_im;
    { /* tw[12] */
      double _xr = *(&in_re[12 * K + k]);
      double _xi = *(&in_im[12 * K + k]);
      double _wr = *(&tw_re[11 * K + k]);
      double _wi = *(&tw_im[11 * K + k]);
      Th_re = (_xr * _wr - (_xi * _wi));
      Th_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[10] */
      ...
      Ti_re = (_xr * _wr - (_xi * _wi));
      Ti_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[4] */
      ...
      Tj_re = (_xr * _wr - (_xi * _wi));
      Tj_im = (_xr * _wi + (_xi * _wr));
    }
    Tk_re = (Ti_re + Tj_re);
    Tk_im = (Ti_im + Tj_im);
    Tl_re = (Th_re + Tk_re);
    ...
    { /* tw[3] */
      ...
      Td_re = (_xr * _wr - (_xi * _wi));
      Td_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[9] */
    ...
    double T8_re, T8_im;
    { /* tw[11] */
      double _xr = *(&in_re[11 * K + k]);
      double _xi = *(&in_im[11 * K + k]);
      double _wr = *(&tw_re[10 * K + k]);
      double _wi = *(&tw_im[10 * K + k]);
      T4_re = (_xr * _wr - (_xi * _wi));
      T4_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[6] */
    ...
    { /* tw[7] */
      ...
      T7_re = (_xr * _wr - (_xi * _wi));
      T7_im = (_xr * _wi + (_xi * _wr));
    }
    { /* tw[2] */
...
static void radix13_genfft_tw_dif_bwd_scalar(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 1)
  {
    ...
    *(&out_im[k]) = (TW_im + TX_im);
    ...
    T10_im = (TS_im + TZ_im);
    { /* dif tw[1] */
      double _yr = (TF_re + T10_re);
      double _yi = (TF_im + T10_im);
      double _wr = *(&tw_re[0 * K + k]);
      double _wi = *(&tw_im[0 * K + k]);
    ...
    { /* dif tw[12] */
      double _yr = (T10_re - TF_re);
      double _yi = (T10_im - TF_im);
      double _wr = *(&tw_re[11 * K + k]);
      double _wi = *(&tw_im[11 * K + k]);
      *(&out_re[12 * K + k]) = (_yr * _wr + (_yi * _wi));
      *(&out_im[12 * K + k]) = (_yi * _wr - (_yr * _wi));
    }
    double T15_re, T15_im, T16_re, T16_im, T1p_re, T1p_im;
    double T1q_re, T1q_im;
    T15_re = (-(KP2_000000000 * T14_im + T11_im));
    ...
    T16_im = (TZ_im - TS_im);
    { /* dif tw[5] */
      double _yr = (T15_re + T16_re);
      double _yi = (T15_im + T16_im);
      double _wr = *(&tw_re[4 * K + k]);
      double _wi = *(&tw_im[4 * K + k]);
    ...
    { /* dif tw[8] */
      double _yr = (T16_re - T15_re);
      double _yi = (T16_im - T15_im);
      double _wr = *(&tw_re[7 * K + k]);
      double _wi = *(&tw_im[7 * K + k]);
    ...
    T1q_im = (T1j_re + T1k_re);
    { /* dif tw[4] */
      double _yr = (T1p_re - T1q_re);
      double _yi = (T1p_im - T1q_im);
      double _wr = *(&tw_re[3 * K + k]);
      double _wi = *(&tw_im[3 * K + k]);
    ...
    { /* dif tw[9] */
      double _yr = (T1q_re + T1p_re);
      double _yi = (T1q_im + T1p_im);
      double _wr = *(&tw_re[8 * K + k]);
      double _wi = *(&tw_im[8 * K + k]);
    ...
    T1o_im = (T1m_im - T1n_im);
    { /* dif tw[3] */
      double _yr = (T1l_re + T1o_re);
      double _yi = (T1l_im + T1o_im);
      double _wr = *(&tw_re[2 * K + k]);
      double _wi = *(&tw_im[2 * K + k]);
    ...
    { /* dif tw[10] */
      double _yr = (T1o_re - T1l_re);
      double _yi = (T1o_im - T1l_im);
      double _wr = *(&tw_re[9 * K + k]);
      double _wi = *(&tw_im[9 * K + k]);
    ...
    T1i_im = (T1f_im - T1c_im);
    { /* dif tw[6] */
      double _yr = (T1h_re + T1i_re);
      double _yi = (T1h_im + T1i_im);
      double _wr = *(&tw_re[5 * K + k]);
      double _wi = *(&tw_im[5 * K + k]);
    ...
    { /* dif tw[7] */
      double _yr = (T1i_re - T1h_re);
      double _yi = (T1i_im - T1h_im);
      double _wr = *(&tw_re[6 * K + k]);
      double _wi = *(&tw_im[6 * K + k]);
    ...
    T1g_im = (T1c_im + T1f_im);
    { /* dif tw[2] */
      double _yr = (T19_re + T1g_re);
      double _yi = (T19_im + T1g_im);
      double _wr = *(&tw_re[1 * K + k]);
      double _wi = *(&tw_im[1 * K + k]);
    ...
    { /* dif tw[11] */
      double _yr = (T1g_re - T19_re);
      double _yi = (T1g_im - T19_im);
      double _wr = *(&tw_re[10 * K + k]);
      double _wi = *(&tw_im[10 * K + k]);
      *(&out_re[11 * K + k]) = (_yr * _wr + (_yi * _wi));
      *(&out_im[11 * K + k]) = (_yi * _wr - (_yr * _wi));
    }
  }
}
...
#ifdef __AVX512F__
__attribute__((target("avx512f,avx512dq,fma"))) static void radix13_genfft_tw_fwd_avx512(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 8)
  {
    ...
    { /* tw[8] */
      ...
      T1_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      T1_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[5] */
    ...
    __m512d Tk_re, Tk_im;
    { /* tw[12] */
      __m512d _xr = _mm512_load_pd(&in_re[12 * K + k]);
      __m512d _xi = _mm512_load_pd(&in_im[12 * K + k]);
      __m512d _wr = _mm512_load_pd(&tw_re[11 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[11 * K + k]);
      Th_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      Th_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[10] */
      ...
      Ti_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      Ti_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[4] */
      ...
      Tj_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      Tj_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    Tk_re = _mm512_add_pd(Ti_re, Tj_re);
    Tk_im = _mm512_add_pd(Ti_im, Tj_im);
    Tl_re = _mm512_add_pd(Th_re, Tk_re);
    ...
    { /* tw[3] */
      ...
      Td_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      Td_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[9] */
    ...
    __m512d T8_re, T8_im;
    { /* tw[11] */
      __m512d _xr = _mm512_load_pd(&in_re[11 * K + k]);
      __m512d _xi = _mm512_load_pd(&in_im[11 * K + k]);
      __m512d _wr = _mm512_load_pd(&tw_re[10 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[10 * K + k]);
      T4_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      T4_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[6] */
    ...
    { /* tw[7] */
      ...
      T7_re = _mm512_fmsub_pd(_xr, _wr, _mm512_mul_pd(_xi, _wi));
      T7_im = _mm512_fmadd_pd(_xr, _wi, _mm512_mul_pd(_xi, _wr));
    }
    { /* tw[2] */
...
__attribute__((target("avx512f,avx512dq,fma"))) static void radix13_genfft_tw_dif_bwd_avx512(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 8)
  {
    ...
    T10_im = _mm512_add_pd(TS_im, TZ_im);
    { /* dif tw[1] */
      __m512d _yr = _mm512_add_pd(TF_re, T10_re);
      __m512d _yi = _mm512_add_pd(TF_im, T10_im);
      __m512d _wr = _mm512_load_pd(&tw_re[0 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[0 * K + k]);
    ...
    { /* dif tw[12] */
      __m512d _yr = _mm512_sub_pd(T10_re, TF_re);
      __m512d _yi = _mm512_sub_pd(T10_im, TF_im);
      __m512d _wr = _mm512_load_pd(&tw_re[11 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[11 * K + k]);
      _mm512_store_pd(&out_re[12 * K + k], _mm512_fmadd_pd(_yr, _wr, _mm512_mul_pd(_yi, _wi)));
      _mm512_store_pd(&out_im[12 * K + k], _mm512_fmsub_pd(_yi, _wr, _mm512_mul_pd(_yr, _wi)));
    }
    __m512d T15_re, T15_im, T16_re, T16_im, T1p_re, T1p_im;
    __m512d T1q_re, T1q_im;
    T15_re = _mm512_xor_pd(_mm512_fmadd_pd(KP2_000000000, T14_im, T11_im), sign_flip);
    ...
    T16_im = _mm512_sub_pd(TZ_im, TS_im);
    { /* dif tw[5] */
      __m512d _yr = _mm512_add_pd(T15_re, T16_re);
      __m512d _yi = _mm512_add_pd(T15_im, T16_im);
      __m512d _wr = _mm512_load_pd(&tw_re[4 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[4 * K + k]);
    ...
    { /* dif tw[8] */
      __m512d _yr = _mm512_sub_pd(T16_re, T15_re);
      __m512d _yi = _mm512_sub_pd(T16_im, T15_im);
      __m512d _wr = _mm512_load_pd(&tw_re[7 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[7 * K + k]);
    ...
    T1q_im = _mm512_add_pd(T1j_re, T1k_re);
    { /* dif tw[4] */
      __m512d _yr = _mm512_sub_pd(T1p_re, T1q_re);
      __m512d _yi = _mm512_sub_pd(T1p_im, T1q_im);
      __m512d _wr = _mm512_load_pd(&tw_re[3 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[3 * K + k]);
    ...
    { /* dif tw[9] */
      __m512d _yr = _mm512_add_pd(T1q_re, T1p_re);
      __m512d _yi = _mm512_add_pd(T1q_im, T1p_im);
      __m512d _wr = _mm512_load_pd(&tw_re[8 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[8 * K + k]);
    ...
    T1o_im = _mm512_sub_pd(T1m_im, T1n_im);
    { /* dif tw[3] */
      __m512d _yr = _mm512_add_pd(T1l_re, T1o_re);
      __m512d _yi = _mm512_add_pd(T1l_im, T1o_im);
      __m512d _wr = _mm512_load_pd(&tw_re[2 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[2 * K + k]);
    ...
    { /* dif tw[10] */
      __m512d _yr = _mm512_sub_pd(T1o_re, T1l_re);
      __m512d _yi = _mm512_sub_pd(T1o_im, T1l_im);
      __m512d _wr = _mm512_load_pd(&tw_re[9 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[9 * K + k]);
    ...
    T1i_im = _mm512_sub_pd(T1f_im, T1c_im);
    { /* dif tw[6] */
      __m512d _yr = _mm512_add_pd(T1h_re, T1i_re);
      __m512d _yi = _mm512_add_pd(T1h_im, T1i_im);
      __m512d _wr = _mm512_load_pd(&tw_re[5 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[5 * K + k]);
    ...
    { /* dif tw[7] */
      __m512d _yr = _mm512_sub_pd(T1i_re, T1h_re);
      __m512d _yi = _mm512_sub_pd(T1i_im, T1h_im);
      __m512d _wr = _mm512_load_pd(&tw_re[6 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[6 * K + k]);
    ...
    T1g_im = _mm512_add_pd(T1c_im, T1f_im);
    { /* dif tw[2] */
      __m512d _yr = _mm512_add_pd(T19_re, T1g_re);
      __m512d _yi = _mm512_add_pd(T19_im, T1g_im);
      __m512d _wr = _mm512_load_pd(&tw_re[1 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[1 * K + k]);
    ...
    { /* dif tw[11] */
      __m512d _yr = _mm512_sub_pd(T1g_re, T19_re);
      __m512d _yi = _mm512_sub_pd(T1g_im, T19_im);
      __m512d _wr = _mm512_load_pd(&tw_re[10 * K + k]);
      __m512d _wi = _mm512_load_pd(&tw_im[10 * K + k]);
      _mm512_store_pd(&out_re[11 * K + k], _mm512_fmadd_pd(_yr, _wr, _mm512_mul_pd(_yi, _wi)));
      _mm512_store_pd(&out_im[11 * K + k], _mm512_fmsub_pd(_yi, _wr, _mm512_mul_pd(_yr, _wi)));
    }
  }
}
...
#ifdef __AVX2__
__attribute__((target("avx2,fma"))) static void radix13_genfft_tw_fwd_avx2(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 4)
  {
    ...
    { /* tw[8] */
      ...
      T1_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      T1_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[5] */
    ...
    __m256d Tk_re, Tk_im;
    { /* tw[12] */
      __m256d _xr = _mm256_load_pd(&in_re[12 * K + k]);
      __m256d _xi = _mm256_load_pd(&in_im[12 * K + k]);
      __m256d _wr = _mm256_load_pd(&tw_re[11 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[11 * K + k]);
      Th_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      Th_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[10] */
      ...
      Ti_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      Ti_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[4] */
      ...
      Tj_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      Tj_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    Tk_re = _mm256_add_pd(Ti_re, Tj_re);
    Tk_im = _mm256_add_pd(Ti_im, Tj_im);
    Tl_re = _mm256_add_pd(Th_re, Tk_re);
    ...
    { /* tw[3] */
      ...
      Td_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      Td_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[9] */
    ...
    __m256d T8_re, T8_im;
    { /* tw[11] */
      __m256d _xr = _mm256_load_pd(&in_re[11 * K + k]);
      __m256d _xi = _mm256_load_pd(&in_im[11 * K + k]);
      __m256d _wr = _mm256_load_pd(&tw_re[10 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[10 * K + k]);
      T4_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      T4_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[6] */
    ...
    { /* tw[7] */
      ...
      T7_re = _mm256_fmsub_pd(_xr, _wr, _mm256_mul_pd(_xi, _wi));
      T7_im = _mm256_fmadd_pd(_xr, _wi, _mm256_mul_pd(_xi, _wr));
    }
    { /* tw[2] */
...
__attribute__((target("avx2,fma"))) static void radix13_genfft_tw_dif_bwd_avx2(
    const double *R13_RESTRICT in_re, const double *R13_RESTRICT in_im,
    double *R13_RESTRICT out_re, double *R13_RESTRICT out_im,
    const double *R13_RESTRICT tw_re, const double *R13_RESTRICT tw_im,
    size_t K)
{
  ...
  for (size_t k = 0; k < K; k += 4)
  {
    ...
    T10_im = _mm256_add_pd(TS_im, TZ_im);
    { /* dif tw[1] */
      __m256d _yr = _mm256_add_pd(TF_re, T10_re);
      __m256d _yi = _mm256_add_pd(TF_im, T10_im);
      __m256d _wr = _mm256_load_pd(&tw_re[0 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[0 * K + k]);
    ...
    { /* dif tw[12] */
      __m256d _yr = _mm256_sub_pd(T10_re, TF_re);
      __m256d _yi = _mm256_sub_pd(T10_im, TF_im);
      __m256d _wr = _mm256_load_pd(&tw_re[11 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[11 * K + k]);
      _mm256_store_pd(&out_re[12 * K + k], _mm256_fmadd_pd(_yr, _wr, _mm256_mul_pd(_yi, _wi)));
      _mm256_store_pd(&out_im[12 * K + k], _mm256_fmsub_pd(_yi, _wr, _mm256_mul_pd(_yr, _wi)));
    }
    __m256d T15_re, T15_im, T16_re, T16_im, T1p_re, T1p_im;
    __m256d T1q_re, T1q_im;
    T15_re = _mm256_xor_pd(_mm256_fmadd_pd(KP2_000000000, T14_im, T11_im), sign_flip);
    ...
    T16_im = _mm256_sub_pd(TZ_im, TS_im);
    { /* dif tw[5] */
      __m256d _yr = _mm256_add_pd(T15_re, T16_re);
      __m256d _yi = _mm256_add_pd(T15_im, T16_im);
      __m256d _wr = _mm256_load_pd(&tw_re[4 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[4 * K + k]);
    ...
    { /* dif tw[8] */
      __m256d _yr = _mm256_sub_pd(T16_re, T15_re);
      __m256d _yi = _mm256_sub_pd(T16_im, T15_im);
      __m256d _wr = _mm256_load_pd(&tw_re[7 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[7 * K + k]);
    ...
    T1q_im = _mm256_add_pd(T1j_re, T1k_re);
    { /* dif tw[4] */
      __m256d _yr = _mm256_sub_pd(T1p_re, T1q_re);
      __m256d _yi = _mm256_sub_pd(T1p_im, T1q_im);
      __m256d _wr = _mm256_load_pd(&tw_re[3 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[3 * K + k]);
    ...
    { /* dif tw[9] */
      __m256d _yr = _mm256_add_pd(T1q_re, T1p_re);
      __m256d _yi = _mm256_add_pd(T1q_im, T1p_im);
      __m256d _wr = _mm256_load_pd(&tw_re[8 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[8 * K + k]);
    ...
    T1o_im = _mm256_sub_pd(T1m_im, T1n_im);
    { /* dif tw[3] */
      __m256d _yr = _mm256_add_pd(T1l_re, T1o_re);
      __m256d _yi = _mm256_add_pd(T1l_im, T1o_im);
      __m256d _wr = _mm256_load_pd(&tw_re[2 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[2 * K + k]);
    ...
    { /* dif tw[10] */
      __m256d _yr = _mm256_sub_pd(T1o_re, T1l_re);
      __m256d _yi = _mm256_sub_pd(T1o_im, T1l_im);
      __m256d _wr = _mm256_load_pd(&tw_re[9 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[9 * K + k]);
    ...
    T1i_im = _mm256_sub_pd(T1f_im, T1c_im);
    { /* dif tw[6] */
      __m256d _yr = _mm256_add_pd(T1h_re, T1i_re);
      __m256d _yi = _mm256_add_pd(T1h_im, T1i_im);
      __m256d _wr = _mm256_load_pd(&tw_re[5 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[5 * K + k]);
    ...
    { /* dif tw[7] */
      __m256d _yr = _mm256_sub_pd(T1i_re, T1h_re);
      __m256d _yi = _mm256_sub_pd(T1i_im, T1h_im);
      __m256d _wr = _mm256_load_pd(&tw_re[6 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[6 * K + k]);
    ...
    T1g_im = _mm256_add_pd(T1c_im, T1f_im);
    { /* dif tw[2] */
      __m256d _yr = _mm256_add_pd(T19_re, T1g_re);
      __m256d _yi = _mm256_add_pd(T19_im, T1g_im);
      __m256d _wr = _mm256_load_pd(&tw_re[1 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[1 * K + k]);
    ...
    { /* dif tw[11] */
      __m256d _yr = _mm256_sub_pd(T1g_re, T19_re);
      __m256d _yi = _mm256_sub_pd(T1g_im, T19_im);
      __m256d _wr = _mm256_load_pd(&tw_re[10 * K + k]);
      __m256d _wi = _mm256_load_pd(&tw_im[10 * K + k]);
      _mm256_store_pd(&out_re[11 * K + k], _mm256_fmadd_pd(_yr, _wr, _mm256_mul_pd(_yi, _wi)));
      _mm256_store_pd(&out_im[11 * K + k], _mm256_fmsub_pd(_yi, _wr, _mm256_mul_pd(_yr, _wi)));
    }
  }
}
