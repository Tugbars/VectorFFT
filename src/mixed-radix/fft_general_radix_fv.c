//==============================================================================
// fft_general_radix_fv.c - Forward General Radix Butterfly
//==============================================================================
...
void fft_general_radix_fv(
    ...
    const fft_data *restrict dft_kernel_tw,  // ⚡ NEW PARAMETER
    int radix,
    int sub_len)
{
    const int r = radix;
    ...
    // Validate
    if (r > 64 || !dft_kernel_tw) {
        fprintf(stderr, "Error: Invalid radix %d or NULL dft_kernel_tw\n", r);
        return;
    }
    
    //==========================================================================
    // Use precomputed DFT kernel twiddles (⚡ NO COMPUTATION!)
    //==========================================================================
