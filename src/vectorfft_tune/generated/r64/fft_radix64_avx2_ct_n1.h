    ...
    const double *__restrict__ W_re, const double *__restrict__ W_im)
{
  ...
  const size_t is = 4;
  {
    ...
    for (size_t g = 0; g < 16; g++)
    {
      ...
      ST(&out_re[0 * 64 + b], y0_re);
      ST(&out_im[0 * 64 + b], y0_im);
      ST(&out_re[1 * 64 + b], y1_re);
      ST(&out_im[1 * 64 + b], y1_im);
      ST(&out_re[2 * 64 + b], y2_re);
      ST(&out_im[2 * 64 + b], y2_im);
      ST(&out_re[3 * 64 + b], y3_re);
      ST(&out_im[3 * 64 + b], y3_im);
    }
  }
}
