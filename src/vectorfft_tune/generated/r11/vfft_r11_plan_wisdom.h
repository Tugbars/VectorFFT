...
static inline int radix11_prefer_dit_log3(size_t me, size_t ios) {
    /* Sparse DIT-log3 wins at 4 specific (me, ios) cells: (16,512), (64,2048), (128,4096), (256,8192) */
    if ((me == 16 && ios == 512) || (me == 64 && ios == 2048) || (me == 128 && ios == 4096) || (me == 256 && ios == 8192)) return 1;
    return 0;
}
