...
static inline void vfft_r4_t1s_dit_dispatch_fwd_avx512(
    ...
    size_t ios, size_t me)
{
     ...
     */
    {
        radix4_t1s_dit_fwd_avx512(rio_re, rio_im, W_re, W_im, ios, me);
        return;
    }
}

static inline void vfft_r4_t1s_dit_dispatch_bwd_avx512(
    double * __restrict__ rio_re, double * __restrict__ rio_im,
    const double * __restrict__ W_re, const double * __restrict__ W_im,
    size_t ios, size_t me)
{
     ...
     */
    {
        radix4_t1s_dit_bwd_avx512(rio_re, rio_im, W_re, W_im, ios, me);
        return;
    }
}

#endif /* VFFT_R4_T1S_DIT_DISPATCH_AVX512_H */
