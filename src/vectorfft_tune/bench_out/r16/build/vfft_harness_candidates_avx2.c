...
const candidate_t CANDIDATES_AVX2[] = {
  ...
  {"ct_t1_buf_dit_tile64_stream", "avx2", "flat", radix16_t1_buf_dit_tile64_stream_fwd_avx2, radix16_t1_buf_dit_tile64_stream_bwd_avx2, 0},
  ...
  {"ct_t1_buf_dit_tile128_stream", "avx2", "flat", radix16_t1_buf_dit_tile128_stream_fwd_avx2, radix16_t1_buf_dit_tile128_stream_bwd_avx2, 0},
  {"ct_t1_buf_dit_tile256_temporal", "avx2", "flat", radix16_t1_buf_dit_tile256_temporal_fwd_avx2, radix16_t1_buf_dit_tile256_temporal_bwd_avx2, 0},
  {"ct_t1_buf_dit_tile256_stream", "avx2", "flat", radix16_t1_buf_dit_tile256_stream_fwd_avx2, radix16_t1_buf_dit_tile256_stream_bwd_avx2, 0},
};
