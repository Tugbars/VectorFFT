...
#define ADD_CASE_MIN_ME(TAG, ISA, DIR, PROTO, REF, DISP, MINME) \
  ...
  #if defined(VALIDATE_AVX2)
    ADD_CASE("t1_dit",      avx2, fwd, "flat",
             radix12_t1_dit_fwd_avx2,       vfft_r12_t1_dit_dispatch_fwd_avx2),
    ADD_CASE("t1_dit",      avx2, bwd, "flat",
             radix12_t1_dit_bwd_avx2,       vfft_r12_t1_dit_dispatch_bwd_avx2),
    ADD_CASE("t1s_dit",     avx2, fwd, "t1s",
             radix12_t1s_dit_fwd_avx2,      vfft_r12_t1s_dit_dispatch_fwd_avx2),
    ADD_CASE("t1s_dit",     avx2, bwd, "t1s",
             radix12_t1s_dit_bwd_avx2,      vfft_r12_t1s_dit_dispatch_bwd_avx2),
    ADD_CASE("t1_dit_log3", avx2, fwd, "log3",
             radix12_t1_dit_log3_fwd_avx2,  vfft_r12_t1_dit_log3_dispatch_fwd_avx2),
    ADD_CASE("t1_dit_log3", avx2, bwd, "log3",
             radix12_t1_dit_log3_bwd_avx2,  vfft_r12_t1_dit_log3_dispatch_bwd_avx2),
  #endif
  #if defined(VALIDATE_AVX512)
    ADD_CASE("t1_dit",      avx512, fwd, "flat",
             radix12_t1_dit_fwd_avx512,       vfft_r12_t1_dit_dispatch_fwd_avx512),
    ADD_CASE("t1_dit",      avx512, bwd, "flat",
             radix12_t1_dit_bwd_avx512,       vfft_r12_t1_dit_dispatch_bwd_avx512),
    ADD_CASE("t1s_dit",     avx512, fwd, "t1s",
             radix12_t1s_dit_fwd_avx512,      vfft_r12_t1s_dit_dispatch_fwd_avx512),
    ADD_CASE("t1s_dit",     avx512, bwd, "t1s",
             radix12_t1s_dit_bwd_avx512,      vfft_r12_t1s_dit_dispatch_bwd_avx512),
    ADD_CASE("t1_dit_log3", avx512, fwd, "log3",
             radix12_t1_dit_log3_fwd_avx512,  vfft_r12_t1_dit_log3_dispatch_fwd_avx512),
    ADD_CASE("t1_dit_log3", avx512, bwd, "log3",
             radix12_t1_dit_log3_bwd_avx512,  vfft_r12_t1_dit_log3_dispatch_bwd_avx512),
    ADD_CASE_MIN_ME("u2a_flat", avx512, fwd, "flat",
                    radix12_t1_dit_fwd_avx512,
                    radix12_t1_dit_u2a_fwd_avx512, 16),
    ADD_CASE_MIN_ME("u2a_flat", avx512, bwd, "flat",
                    radix12_t1_dit_bwd_avx512,
                    radix12_t1_dit_u2a_bwd_avx512, 16),
    ADD_CASE_MIN_ME("u2b_flat", avx512, fwd, "flat",
                    radix12_t1_dit_fwd_avx512,
                    radix12_t1_dit_u2b_fwd_avx512, 16),
    ADD_CASE_MIN_ME("u2b_flat", avx512, bwd, "flat",
                    radix12_t1_dit_bwd_avx512,
                    radix12_t1_dit_u2b_bwd_avx512, 16),
    ADD_CASE_MIN_ME("u2a_log3", avx512, fwd, "log3",
                    radix12_t1_dit_log3_fwd_avx512,
                    radix12_t1_dit_log3_u2a_fwd_avx512, 16),
    ADD_CASE_MIN_ME("u2a_log3", avx512, bwd, "log3",
                    radix12_t1_dit_log3_bwd_avx512,
                    radix12_t1_dit_log3_u2a_bwd_avx512, 16),
    ADD_CASE_MIN_ME("u2b_log3", avx512, fwd, "log3",
                    radix12_t1_dit_log3_fwd_avx512,
                    radix12_t1_dit_log3_u2b_fwd_avx512, 16),
    ADD_CASE_MIN_ME("u2b_log3", avx512, bwd, "log3",
                    radix12_t1_dit_log3_bwd_avx512,
                    radix12_t1_dit_log3_u2b_bwd_avx512, 16),
  #endif
   ...
   * which is functionally correct but pointless — we gate at enumeration time. */
    ...
    ADD_CASE("t1_dit",      avx2, bwd, "flat",
             radix25_t1_dit_bwd_avx2,       vfft_r25_t1_dit_dispatch_bwd_avx2),
    ADD_CASE("t1s_dit",     avx2, fwd, "t1s",
             radix25_t1s_dit_fwd_avx2,      vfft_r25_t1s_dit_dispatch_fwd_avx2),
    ADD_CASE("t1s_dit",     avx2, bwd, "t1s",
             radix25_t1s_dit_bwd_avx2,      vfft_r25_t1s_dit_dispatch_bwd_avx2),
    ADD_CASE("t1_dit_log3", avx2, fwd, "log3",
  ...
  #if defined(VALIDATE_AVX512)
    ADD_CASE("t1_dit",      avx512, fwd, "flat",
             radix25_t1_dit_fwd_avx512,       vfft_r25_t1_dit_dispatch_fwd_avx512),
    ADD_CASE("t1_dit",      avx512, bwd, "flat",
             radix25_t1_dit_bwd_avx512,       vfft_r25_t1_dit_dispatch_bwd_avx512),
    ADD_CASE("t1s_dit",     avx512, fwd, "t1s",
             radix25_t1s_dit_fwd_avx512,      vfft_r25_t1s_dit_dispatch_fwd_avx512),
    ADD_CASE("t1s_dit",     avx512, bwd, "t1s",
             radix25_t1s_dit_bwd_avx512,      vfft_r25_t1s_dit_dispatch_bwd_avx512),
    ADD_CASE("t1_dit_log3", avx512, fwd, "log3",
...
static const size_t ME_N_R25 = sizeof(ME_GRID_R25) / sizeof(ME_GRID_R25[0]);
