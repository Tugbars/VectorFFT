...
__attribute__((target("avx512f"))) static inline void radix32_pack_input_avx512(
...
__attribute__((target("avx512f"))) static inline void radix32_unpack_output_avx512(
    const double *__restrict__ src_re, const double *__restrict__ src_im,
    double *__restrict__ dst_re, double *__restrict__ dst_im,
    size_t K)
{
...
__attribute__((target("avx512f"))) static inline void radix32_pack_twiddles_avx512(
    const double *__restrict__ src_re, const double *__restrict__ src_im,
    double *__restrict__ dst_re, double *__restrict__ dst_im,
    size_t K)
{
