/**
 * @file fft_radix32_avx512_notw.h
 * @brief Twiddle-less DFT-32 AVX512 codelet
 *
 * Pure DFT-32 butterfly, no inter-stage twiddles.
 * 8-wide doubles, NFUSE=8, 8x4 decomposition
 * Generated by gen_radix32_notw.py avx512
 */

#ifndef FFT_RADIX32_AVX512_NOTW_H
#define FFT_RADIX32_AVX512_NOTW_H
...
#ifndef R32N5_LD
#define R32N5_LD(p) _mm512_loadu_pd(p)
#endif
#ifndef R32N5_ST
#define R32N5_ST(p,v) _mm512_storeu_pd((p),(v))
#endif
#define LD R32N5_LD
#define ST R32N5_ST

/* === TWIDDLE-LESS DFT-32 AVX512 (NFUSE=8) === */
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        ...
        /* FUSED: save x0..x7 to s-regs (no spills!) */
...
#endif /* FFT_RADIX32_AVX512_NOTW_H */
