/**
 * @file fft_radix32_avx512_n1_u2.h
 * @brief DFT-32 AVX-512 N1 — U=1 (prefetch) + U=2 (interleaved+prefetch)
 *
 * U=1: k-step=8,  32-slot spill (2KB), software prefetch
 * U=2: k-step=16, 64-slot spill (4KB), interleaved A/B pipelines + prefetch
 * 8×4: 4 radix-8 sub-FFTs + 8 radix-4 combines
 * Generated by gen_radix32_avx512_n1_u2.py
 */

#ifndef FFT_RADIX32_AVX512_N1_U2_H
#define FFT_RADIX32_AVX512_N1_U2_H
...
#ifndef R32U_LD
#define R32U_LD(p) _mm512_loadu_pd(p)
#endif
#ifndef R32U_ST
#define R32U_ST(p,v) _mm512_storeu_pd((p),(v))
#endif
...
/* ════════════════════════════════════════════════════════════ */
/*  U=1 KERNELS — k-step=8, prefetch, K≥8                    */
/* ════════════════════════════════════════════════════════════ */

static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_n1_dit_kernel_fwd_avx512_u1(
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        /* PASS 1: 4 radix-8 sub-FFTs [fwd] */

        /* sub-FFT n₂=0 */
        /* prefetch n₂=1 at k_pf=k */
        _mm_prefetch((const char*)&in_re[1 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[1 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[5 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[5 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[9 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[9 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[13 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[13 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[17 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[17 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[21 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[21 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[25 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[25 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[29 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[29 * K + k], _MM_HINT_T0);
        ...
        /* sub-FFT n₂=1 */
        /* prefetch n₂=2 at k_pf=k */
        _mm_prefetch((const char*)&in_re[2 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[2 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[6 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[6 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[10 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[10 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[14 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[14 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[18 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[18 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[22 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[22 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[26 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[26 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[30 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[30 * K + k], _MM_HINT_T0);
        ...
        /* sub-FFT n₂=2 */
        /* prefetch n₂=3 at k_pf=k */
        _mm_prefetch((const char*)&in_re[3 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[3 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[7 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[7 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[11 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[11 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[15 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[15 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[19 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[19 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[23 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[23 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[27 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[27 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[31 * K + k], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[31 * K + k], _MM_HINT_T0);
        ...
        /* sub-FFT n₂=3 */
        /* prefetch n₂=0 at k_pf=k + 8 */
        _mm_prefetch((const char*)&in_re[0 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[0 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[4 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[4 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[8 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[8 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[12 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[12 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[16 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[16 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[20 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[20 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[24 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[24 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[28 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[28 * K + k + 8], _MM_HINT_T0);
...
/* ════════════════════════════════════════════════════════════ */
/*  U=2 KERNELS — k-step=16, interleaved pipelines, K≥16     */
/* ════════════════════════════════════════════════════════════ */

static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_n1_dit_kernel_fwd_avx512_u2(
    const double * __restrict__ in_re, const double * __restrict__ in_im,
    double * __restrict__ out_re, double * __restrict__ out_im,
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 16) {
        /* PASS 1: 4 radix-8 sub-FFTs × 2 pipelines [fwd] */

        /* ═══ pipeline A, sub-FFT n₂=0 ═══ */
        /* prefetch B n₂=0 */
        _mm_prefetch((const char*)&in_re[0 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[0 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[4 * K + k + 8], _MM_HINT_T0);
        ...
        /* ═══ pipeline A, sub-FFT n₂=1 ═══ */
        /* prefetch B n₂=1 */
        _mm_prefetch((const char*)&in_re[1 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[1 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[5 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[5 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[9 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[9 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[13 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[13 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[17 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[17 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[21 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[21 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[25 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[25 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[29 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[29 * K + k + 8], _MM_HINT_T0);
        ...
        /* ═══ pipeline A, sub-FFT n₂=2 ═══ */
        /* prefetch B n₂=2 */
        _mm_prefetch((const char*)&in_re[2 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[2 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[6 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[6 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[10 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[10 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[14 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[14 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[18 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[18 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[22 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[22 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[26 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[26 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[30 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[30 * K + k + 8], _MM_HINT_T0);
        ...
        /* ═══ pipeline A, sub-FFT n₂=3 ═══ */
        /* prefetch B n₂=3 */
        _mm_prefetch((const char*)&in_re[3 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[3 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[7 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[7 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[11 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[11 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[15 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[15 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[19 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[19 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[23 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[23 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[27 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[27 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[31 * K + k + 8], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[31 * K + k + 8], _MM_HINT_T0);
        ...
        /* ═══ pipeline B, sub-FFT n₂=3 ═══ */
        /* prefetch A n₂=0 at k + 16 */
        _mm_prefetch((const char*)&in_re[0 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[0 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[4 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[4 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[8 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[8 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[12 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[12 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[16 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[16 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[20 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[20 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[24 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[24 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_re[28 * K + k + 16], _MM_HINT_T0);
        _mm_prefetch((const char*)&in_im[28 * K + k + 16], _MM_HINT_T0);
        ...
        /* PASS 2: 8 radix-4 combines × 2 pipelines [fwd] */
        ...
        /* ═══ B, column k₁=0 ═══ */
        x0_re = _mm512_load_pd(&spill_re[32 * 8]);
        x0_im = _mm512_load_pd(&spill_im[32 * 8]);
        x1_re = _mm512_load_pd(&spill_re[40 * 8]);
        x1_im = _mm512_load_pd(&spill_im[40 * 8]);
        x2_re = _mm512_load_pd(&spill_re[48 * 8]);
        x2_im = _mm512_load_pd(&spill_im[48 * 8]);
        ...
        /* ═══ B, column k₁=1 ═══ */
        x0_re = _mm512_load_pd(&spill_re[33 * 8]);
        x0_im = _mm512_load_pd(&spill_im[33 * 8]);
        x1_re = _mm512_load_pd(&spill_re[41 * 8]);
        x1_im = _mm512_load_pd(&spill_im[41 * 8]);
        x2_re = _mm512_load_pd(&spill_re[49 * 8]);
        x2_im = _mm512_load_pd(&spill_im[49 * 8]);
        ...
        /* ═══ B, column k₁=2 ═══ */
        x0_re = _mm512_load_pd(&spill_re[34 * 8]);
        x0_im = _mm512_load_pd(&spill_im[34 * 8]);
        x1_re = _mm512_load_pd(&spill_re[42 * 8]);
        x1_im = _mm512_load_pd(&spill_im[42 * 8]);
        x2_re = _mm512_load_pd(&spill_re[50 * 8]);
        x2_im = _mm512_load_pd(&spill_im[50 * 8]);
        ...
        /* ═══ B, column k₁=3 ═══ */
        x0_re = _mm512_load_pd(&spill_re[35 * 8]);
        x0_im = _mm512_load_pd(&spill_im[35 * 8]);
        x1_re = _mm512_load_pd(&spill_re[43 * 8]);
        x1_im = _mm512_load_pd(&spill_im[43 * 8]);
        x2_re = _mm512_load_pd(&spill_re[51 * 8]);
        x2_im = _mm512_load_pd(&spill_im[51 * 8]);
        ...
        /* ═══ B, column k₁=4 ═══ */
        x0_re = _mm512_load_pd(&spill_re[36 * 8]);
        x0_im = _mm512_load_pd(&spill_im[36 * 8]);
        x1_re = _mm512_load_pd(&spill_re[44 * 8]);
        x1_im = _mm512_load_pd(&spill_im[44 * 8]);
        x2_re = _mm512_load_pd(&spill_re[52 * 8]);
        x2_im = _mm512_load_pd(&spill_im[52 * 8]);
        ...
        /* ═══ B, column k₁=5 ═══ */
        x0_re = _mm512_load_pd(&spill_re[37 * 8]);
        x0_im = _mm512_load_pd(&spill_im[37 * 8]);
        x1_re = _mm512_load_pd(&spill_re[45 * 8]);
        x1_im = _mm512_load_pd(&spill_im[45 * 8]);
        x2_re = _mm512_load_pd(&spill_re[53 * 8]);
        x2_im = _mm512_load_pd(&spill_im[53 * 8]);
        ...
        /* ═══ B, column k₁=6 ═══ */
        x0_re = _mm512_load_pd(&spill_re[38 * 8]);
        x0_im = _mm512_load_pd(&spill_im[38 * 8]);
        x1_re = _mm512_load_pd(&spill_re[46 * 8]);
        x1_im = _mm512_load_pd(&spill_im[46 * 8]);
        x2_re = _mm512_load_pd(&spill_re[54 * 8]);
        x2_im = _mm512_load_pd(&spill_im[54 * 8]);
        ...
        /* ═══ B, column k₁=7 ═══ */
        x0_re = _mm512_load_pd(&spill_re[39 * 8]);
        x0_im = _mm512_load_pd(&spill_im[39 * 8]);
        x1_re = _mm512_load_pd(&spill_re[47 * 8]);
        x1_im = _mm512_load_pd(&spill_im[47 * 8]);
        x2_re = _mm512_load_pd(&spill_re[55 * 8]);
        x2_im = _mm512_load_pd(&spill_im[55 * 8]);
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 16) {
        /* PASS 1: 4 radix-8 sub-FFTs × 2 pipelines [bwd] */
        ...
        /* PASS 2: 8 radix-4 combines × 2 pipelines [bwd] */
...
#endif /* FFT_RADIX32_AVX512_N1_U2_H */
