 ...
 * @brief DFT-32 AVX-512 twiddled: flat (K<=64) + binary-ladder (K>=128)
 *
 * Flat: tw_re[31*K], tw_im[31*K] — 31 loads/k-step, fits L1 for K<=64
 * Ladder: base_tw_re[5*K], base_tw_im[5*K] — 5 loads/k-step, fits L1 for K<=600
 * Generated by gen_radix32_avx512_tw_ladder.py
 */
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        ...
        /* sub-FFT n₂=0: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[0*K+k]);
        x0_im = LD(&in_im[0*K+k]);
        x1_re = LD(&in_re[4*K+k]);
        x1_im = LD(&in_im[4*K+k]);
        ...
        /* sub-FFT n₂=1: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[1*K+k]);
        x0_im = LD(&in_im[1*K+k]);
        x1_re = LD(&in_re[5*K+k]);
        x1_im = LD(&in_im[5*K+k]);
        ...
        /* col twiddle b1 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* sub-FFT n₂=2: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[2*K+k]);
        x0_im = LD(&in_im[2*K+k]);
        x1_re = LD(&in_re[6*K+k]);
        x1_im = LD(&in_im[6*K+k]);
        ...
        /* col twiddle b2 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* sub-FFT n₂=3: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[3*K+k]);
        x0_im = LD(&in_im[3*K+k]);
        x1_re = LD(&in_re[7*K+k]);
        x1_im = LD(&in_im[7*K+k]);
        ...
        /* col twiddle b3 on all 8 outputs */
        { __m512d tr=x0_re;
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 16) {
        ...
        /* A_sub-FFT n₂=0: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[0*K+k]);
        x0_im = LD(&in_im[0*K+k]);
        x1_re = LD(&in_re[4*K+k]);
        x1_im = LD(&in_im[4*K+k]);
        ...
        /* A_sub-FFT n₂=1: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[1*K+k]);
        x0_im = LD(&in_im[1*K+k]);
        x1_re = LD(&in_re[5*K+k]);
        x1_im = LD(&in_im[5*K+k]);
        ...
        /* A_col twiddle b1 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* A_sub-FFT n₂=2: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[2*K+k]);
        x0_im = LD(&in_im[2*K+k]);
        x1_re = LD(&in_re[6*K+k]);
        x1_im = LD(&in_im[6*K+k]);
        ...
        /* A_col twiddle b2 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* A_sub-FFT n₂=3: load + row-twiddle + butterfly */
        x0_re = LD(&in_re[3*K+k]);
        x0_im = LD(&in_im[3*K+k]);
        x1_re = LD(&in_re[7*K+k]);
        x1_im = LD(&in_im[7*K+k]);
        ...
        /* A_col twiddle b3 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* B_sub-FFT n₂=0: load + row-twiddle + butterfly */
        ...
        /* B_sub-FFT n₂=1: load + row-twiddle + butterfly */
        ...
        /* B_col twiddle b1 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* B_sub-FFT n₂=2: load + row-twiddle + butterfly */
        ...
        /* B_col twiddle b2 on all 8 outputs */
        { __m512d tr=x0_re;
        ...
        /* B_sub-FFT n₂=3: load + row-twiddle + butterfly */
        ...
        /* B_col twiddle b3 on all 8 outputs */
        { __m512d tr=x0_re;
