/**
 * @file fft_radix32_avx512_tw.h
 * @brief Twiddled DFT-32 AVX-512 — fused twiddle + butterfly
 *
 * Flat twiddle interface: tw_re[31*K], tw_im[31*K]
 *   tw_re[(n-1)*K + k] = Re(W_outerN^{n*k})
 * 8×4: 4 radix-8 sub-FFTs + 8 radix-4 combines
 * Generated by gen_radix32_avx512_tw.py
 */

#ifndef FFT_RADIX32_AVX512_TW_H
#define FFT_RADIX32_AVX512_TW_H
...
#ifndef R32TW_LD
#define R32TW_LD(p) _mm512_loadu_pd(p)
#endif
#ifndef R32TW_ST
#define R32TW_ST(p,v) _mm512_storeu_pd((p),(v))
#endif
...
/* ════════════════════════════════════════════════════════════ */
/*  U=1 TWIDDLED — k-step=8, K≥8                             */
/* ════════════════════════════════════════════════════════════ */

static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_dit_kernel_fwd_avx512_u1(
    ...
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        /* PASS 1: load + twiddle + 4 radix-8 sub-FFTs [fwd] */
...
static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_dit_kernel_bwd_avx512_u1(
    const double * __restrict__ in_re, const double * __restrict__ in_im,
    double * __restrict__ out_re, double * __restrict__ out_im,
    const double * __restrict__ tw_re, const double * __restrict__ tw_im,
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 8) {
        /* PASS 1: load + twiddle + 4 radix-8 sub-FFTs [bwd] */
...
/* ════════════════════════════════════════════════════════════ */
/*  U=2 TWIDDLED — k-step=16, interleaved, K≥16              */
/* ════════════════════════════════════════════════════════════ */

static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_dit_kernel_fwd_avx512_u2(
    const double * __restrict__ in_re, const double * __restrict__ in_im,
    double * __restrict__ out_re, double * __restrict__ out_im,
    const double * __restrict__ tw_re, const double * __restrict__ tw_im,
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 16) {
        /* PASS 1: load + twiddle + 4 radix-8 × 2 pipelines [fwd] */
        ...
        { __m512d wr = _mm512_load_pd(&tw_re[3 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[3 * K + k + 8]);
          __m512d tr = x1_re;
          x1_re = _mm512_fmsub_pd(x1_re, wr, _mm512_mul_pd(x1_im, wi));
          x1_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x1_im, wr)); }
        x2_re = LD(&in_re[8 * K + k + 8]);
        x2_im = LD(&in_im[8 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[7 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[7 * K + k + 8]);
          __m512d tr = x2_re;
          x2_re = _mm512_fmsub_pd(x2_re, wr, _mm512_mul_pd(x2_im, wi));
          x2_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x2_im, wr)); }
        x3_re = LD(&in_re[12 * K + k + 8]);
        x3_im = LD(&in_im[12 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[11 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[11 * K + k + 8]);
          __m512d tr = x3_re;
          x3_re = _mm512_fmsub_pd(x3_re, wr, _mm512_mul_pd(x3_im, wi));
          x3_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x3_im, wr)); }
        x4_re = LD(&in_re[16 * K + k + 8]);
        x4_im = LD(&in_im[16 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[15 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[15 * K + k + 8]);
          __m512d tr = x4_re;
          x4_re = _mm512_fmsub_pd(x4_re, wr, _mm512_mul_pd(x4_im, wi));
          x4_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x4_im, wr)); }
        x5_re = LD(&in_re[20 * K + k + 8]);
        x5_im = LD(&in_im[20 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[19 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[19 * K + k + 8]);
          __m512d tr = x5_re;
          x5_re = _mm512_fmsub_pd(x5_re, wr, _mm512_mul_pd(x5_im, wi));
          x5_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x5_im, wr)); }
        x6_re = LD(&in_re[24 * K + k + 8]);
        x6_im = LD(&in_im[24 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[23 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[23 * K + k + 8]);
          __m512d tr = x6_re;
          x6_re = _mm512_fmsub_pd(x6_re, wr, _mm512_mul_pd(x6_im, wi));
          x6_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x6_im, wr)); }
        x7_re = LD(&in_re[28 * K + k + 8]);
        x7_im = LD(&in_im[28 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[27 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[27 * K + k + 8]);
          __m512d tr = x7_re;
          x7_re = _mm512_fmsub_pd(x7_re, wr, _mm512_mul_pd(x7_im, wi));
          x7_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x7_im, wr)); }
        ...
        { __m512d wr = _mm512_load_pd(&tw_re[0 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[0 * K + k + 8]);
          __m512d tr = x0_re;
          x0_re = _mm512_fmsub_pd(x0_re, wr, _mm512_mul_pd(x0_im, wi));
          x0_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x0_im, wr)); }
        x1_re = LD(&in_re[5 * K + k + 8]);
        x1_im = LD(&in_im[5 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[4 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[4 * K + k + 8]);
          __m512d tr = x1_re;
          x1_re = _mm512_fmsub_pd(x1_re, wr, _mm512_mul_pd(x1_im, wi));
          x1_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x1_im, wr)); }
        x2_re = LD(&in_re[9 * K + k + 8]);
        x2_im = LD(&in_im[9 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[8 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[8 * K + k + 8]);
          __m512d tr = x2_re;
          x2_re = _mm512_fmsub_pd(x2_re, wr, _mm512_mul_pd(x2_im, wi));
          x2_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x2_im, wr)); }
        x3_re = LD(&in_re[13 * K + k + 8]);
        x3_im = LD(&in_im[13 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[12 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[12 * K + k + 8]);
          __m512d tr = x3_re;
          x3_re = _mm512_fmsub_pd(x3_re, wr, _mm512_mul_pd(x3_im, wi));
          x3_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x3_im, wr)); }
        x4_re = LD(&in_re[17 * K + k + 8]);
        x4_im = LD(&in_im[17 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[16 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[16 * K + k + 8]);
          __m512d tr = x4_re;
          x4_re = _mm512_fmsub_pd(x4_re, wr, _mm512_mul_pd(x4_im, wi));
          x4_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x4_im, wr)); }
        x5_re = LD(&in_re[21 * K + k + 8]);
        x5_im = LD(&in_im[21 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[20 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[20 * K + k + 8]);
          __m512d tr = x5_re;
          x5_re = _mm512_fmsub_pd(x5_re, wr, _mm512_mul_pd(x5_im, wi));
          x5_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x5_im, wr)); }
        x6_re = LD(&in_re[25 * K + k + 8]);
        x6_im = LD(&in_im[25 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[24 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[24 * K + k + 8]);
          __m512d tr = x6_re;
          x6_re = _mm512_fmsub_pd(x6_re, wr, _mm512_mul_pd(x6_im, wi));
          x6_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x6_im, wr)); }
        x7_re = LD(&in_re[29 * K + k + 8]);
        x7_im = LD(&in_im[29 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[28 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[28 * K + k + 8]);
          __m512d tr = x7_re;
          x7_re = _mm512_fmsub_pd(x7_re, wr, _mm512_mul_pd(x7_im, wi));
          x7_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x7_im, wr)); }
        ...
        { __m512d wr = _mm512_load_pd(&tw_re[1 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[1 * K + k + 8]);
          __m512d tr = x0_re;
          x0_re = _mm512_fmsub_pd(x0_re, wr, _mm512_mul_pd(x0_im, wi));
          x0_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x0_im, wr)); }
        x1_re = LD(&in_re[6 * K + k + 8]);
        x1_im = LD(&in_im[6 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[5 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[5 * K + k + 8]);
          __m512d tr = x1_re;
          x1_re = _mm512_fmsub_pd(x1_re, wr, _mm512_mul_pd(x1_im, wi));
          x1_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x1_im, wr)); }
        x2_re = LD(&in_re[10 * K + k + 8]);
        x2_im = LD(&in_im[10 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[9 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[9 * K + k + 8]);
          __m512d tr = x2_re;
          x2_re = _mm512_fmsub_pd(x2_re, wr, _mm512_mul_pd(x2_im, wi));
          x2_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x2_im, wr)); }
        x3_re = LD(&in_re[14 * K + k + 8]);
        x3_im = LD(&in_im[14 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[13 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[13 * K + k + 8]);
          __m512d tr = x3_re;
          x3_re = _mm512_fmsub_pd(x3_re, wr, _mm512_mul_pd(x3_im, wi));
          x3_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x3_im, wr)); }
        x4_re = LD(&in_re[18 * K + k + 8]);
        x4_im = LD(&in_im[18 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[17 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[17 * K + k + 8]);
          __m512d tr = x4_re;
          x4_re = _mm512_fmsub_pd(x4_re, wr, _mm512_mul_pd(x4_im, wi));
          x4_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x4_im, wr)); }
        x5_re = LD(&in_re[22 * K + k + 8]);
        x5_im = LD(&in_im[22 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[21 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[21 * K + k + 8]);
          __m512d tr = x5_re;
          x5_re = _mm512_fmsub_pd(x5_re, wr, _mm512_mul_pd(x5_im, wi));
          x5_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x5_im, wr)); }
        x6_re = LD(&in_re[26 * K + k + 8]);
        x6_im = LD(&in_im[26 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[25 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[25 * K + k + 8]);
          __m512d tr = x6_re;
          x6_re = _mm512_fmsub_pd(x6_re, wr, _mm512_mul_pd(x6_im, wi));
          x6_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x6_im, wr)); }
        x7_re = LD(&in_re[30 * K + k + 8]);
        x7_im = LD(&in_im[30 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[29 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[29 * K + k + 8]);
          __m512d tr = x7_re;
          x7_re = _mm512_fmsub_pd(x7_re, wr, _mm512_mul_pd(x7_im, wi));
          x7_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x7_im, wr)); }
        ...
        { __m512d wr = _mm512_load_pd(&tw_re[2 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[2 * K + k + 8]);
          __m512d tr = x0_re;
          x0_re = _mm512_fmsub_pd(x0_re, wr, _mm512_mul_pd(x0_im, wi));
          x0_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x0_im, wr)); }
        x1_re = LD(&in_re[7 * K + k + 8]);
        x1_im = LD(&in_im[7 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[6 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[6 * K + k + 8]);
          __m512d tr = x1_re;
          x1_re = _mm512_fmsub_pd(x1_re, wr, _mm512_mul_pd(x1_im, wi));
          x1_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x1_im, wr)); }
        x2_re = LD(&in_re[11 * K + k + 8]);
        x2_im = LD(&in_im[11 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[10 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[10 * K + k + 8]);
          __m512d tr = x2_re;
          x2_re = _mm512_fmsub_pd(x2_re, wr, _mm512_mul_pd(x2_im, wi));
          x2_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x2_im, wr)); }
        x3_re = LD(&in_re[15 * K + k + 8]);
        x3_im = LD(&in_im[15 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[14 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[14 * K + k + 8]);
          __m512d tr = x3_re;
          x3_re = _mm512_fmsub_pd(x3_re, wr, _mm512_mul_pd(x3_im, wi));
          x3_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x3_im, wr)); }
        x4_re = LD(&in_re[19 * K + k + 8]);
        x4_im = LD(&in_im[19 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[18 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[18 * K + k + 8]);
          __m512d tr = x4_re;
          x4_re = _mm512_fmsub_pd(x4_re, wr, _mm512_mul_pd(x4_im, wi));
          x4_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x4_im, wr)); }
        x5_re = LD(&in_re[23 * K + k + 8]);
        x5_im = LD(&in_im[23 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[22 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[22 * K + k + 8]);
          __m512d tr = x5_re;
          x5_re = _mm512_fmsub_pd(x5_re, wr, _mm512_mul_pd(x5_im, wi));
          x5_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x5_im, wr)); }
        x6_re = LD(&in_re[27 * K + k + 8]);
        x6_im = LD(&in_im[27 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[26 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[26 * K + k + 8]);
          __m512d tr = x6_re;
          x6_re = _mm512_fmsub_pd(x6_re, wr, _mm512_mul_pd(x6_im, wi));
          x6_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x6_im, wr)); }
        x7_re = LD(&in_re[31 * K + k + 8]);
        x7_im = LD(&in_im[31 * K + k + 8]);
        { __m512d wr = _mm512_load_pd(&tw_re[30 * K + k + 8]);
          __m512d wi = _mm512_load_pd(&tw_im[30 * K + k + 8]);
          __m512d tr = x7_re;
          x7_re = _mm512_fmsub_pd(x7_re, wr, _mm512_mul_pd(x7_im, wi));
          x7_im = _mm512_fmadd_pd(tr, wi, _mm512_mul_pd(x7_im, wr)); }
...
static __attribute__((target("avx512f,avx512dq,fma"))) void
radix32_tw_dit_kernel_bwd_avx512_u2(
    const double * __restrict__ in_re, const double * __restrict__ in_im,
    double * __restrict__ out_re, double * __restrict__ out_im,
    const double * __restrict__ tw_re, const double * __restrict__ tw_im,
    size_t K)
{
    ...
    for (size_t k = 0; k < K; k += 16) {
        /* PASS 1: load + twiddle + 4 radix-8 × 2 pipelines [bwd] */
