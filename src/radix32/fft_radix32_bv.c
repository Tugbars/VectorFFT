 ...
 * @brief Backward (inverse) radix-32 FFT stage — ISA dispatch
 *
 * Entry points:
 *   radix32_backward()              — auto-dispatch (AVX-512 → AVX2 → scalar)
 *   radix32_backward_force_avx512() — forced AVX-512 (for benchmarking)
 *   radix32_backward_force_avx2()   — forced AVX2
 *   radix32_backward_force_scalar() — forced scalar
 *
 * @author Tugbars
 * @date 2025
 */
...
radix32_isa_level_t radix32_backward(
    size_t K,
...
void radix32_backward_force_avx512(
    size_t K,
    const double *RESTRICT in_re,
    const double *RESTRICT in_im,
    double *RESTRICT out_re,
...
void radix32_backward_force_scalar(
    size_t K,
    const double *RESTRICT in_re,
    const double *RESTRICT in_im,
    double *RESTRICT out_re,
