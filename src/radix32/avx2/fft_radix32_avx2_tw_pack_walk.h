...
__attribute__((target("avx2,fma"))) static inline void r32w2_derive_twiddles(
    ...
    double *__restrict__ tw_re, double *__restrict__ tw_im)
{
    ...
    _mm256_store_pd(&tw_re[0 * 4], b_re[0]);
    _mm256_store_pd(&tw_im[0 * 4], b_im[0]);
    _mm256_store_pd(&tw_re[1 * 4], b_re[1]);
    _mm256_store_pd(&tw_im[1 * 4], b_im[1]);
    _mm256_store_pd(&tw_re[3 * 4], b_re[2]);
    _mm256_store_pd(&tw_im[3 * 4], b_im[2]);
    _mm256_store_pd(&tw_re[7 * 4], b_re[3]);
    _mm256_store_pd(&tw_im[7 * 4], b_im[3]);
    _mm256_store_pd(&tw_re[15 * 4], b_re[4]);
    _mm256_store_pd(&tw_im[15 * 4], b_im[4]);

    /* W^3 = W^1 * W^2 */
    __m256d w3r = R32W2_CMUL_RE(b_re[0], b_im[0], b_re[1], b_im[1]);
    __m256d w3i = R32W2_CMUL_IM(b_re[0], b_im[0], b_re[1], b_im[1]);
    _mm256_store_pd(&tw_re[2 * 4], w3r);
    _mm256_store_pd(&tw_im[2 * 4], w3i);

    /* W^5 = W^1 * W^4 */
    __m256d w5r = R32W2_CMUL_RE(b_re[0], b_im[0], b_re[2], b_im[2]);
    __m256d w5i = R32W2_CMUL_IM(b_re[0], b_im[0], b_re[2], b_im[2]);
    _mm256_store_pd(&tw_re[4 * 4], w5r);
    _mm256_store_pd(&tw_im[4 * 4], w5i);

    /* W^6 = W^2 * W^4 */
    __m256d w6r = R32W2_CMUL_RE(b_re[1], b_im[1], b_re[2], b_im[2]);
    __m256d w6i = R32W2_CMUL_IM(b_re[1], b_im[1], b_re[2], b_im[2]);
    _mm256_store_pd(&tw_re[5 * 4], w6r);
    _mm256_store_pd(&tw_im[5 * 4], w6i);

    /* W^7 = W^3 * W^4 */
    __m256d w7r = R32W2_CMUL_RE(w3r, w3i, b_re[2], b_im[2]);
    __m256d w7i = R32W2_CMUL_IM(w3r, w3i, b_re[2], b_im[2]);
    _mm256_store_pd(&tw_re[6 * 4], w7r);
    _mm256_store_pd(&tw_im[6 * 4], w7i);
