                                   ...
                                   int N, size_t K)
{
     ...
     * 2026-09-15): a pow2 cell up to the ceiling has no cascade arm in
    ...
    if (N >= _vfft_zcasc_nat_min_n() && !vfft_ztt_band(N) &&   /* no cascade arm at a pow2 band cell, in any order class (2026-09-15) */
