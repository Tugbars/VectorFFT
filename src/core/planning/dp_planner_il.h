                            ...
                            int *n, int *dropped)
{
     ...
     * at a median 0.49x of MKL -- because no kernel existed at 23 anywhere
     * in the interleaved registry while the split library has had one. */
     ...
     * route and ran the prime cell at a median 0.35x of MKL: nothing in the
