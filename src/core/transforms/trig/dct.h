 ...
 *
 * Inverse (DCT-III) is NOT implemented in v1.0 — defer to next pass.
 *
...
/* Specialized N=8 codelets (auto-generated by gen_dct8.py / gen_dct3_n8.py).
 * Closes the JPEG-block performance gap vs the comparison baseline's
 * hand-written size-8 DCT-II / DCT-III codelets. */
#if defined(__AVX2__)
