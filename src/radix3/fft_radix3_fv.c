//==============================================================================
// fft_radix3_fv.c - Forward Radix-3 Butterfly (OPTIMIZED)
//==============================================================================
//
// ARCHITECTURE:
    ...
    int sub_len)
{
    ...
    if (use_streaming) {
        ...
        for (; k + 1 < K; k += 2) {
            ...
            RADIX3_PIPELINE_2_FV_AVX2_STREAM(k, K, sub_outputs, stage_tw, output_buffer, v_sqrt3_2);
        }
        _mm_sfence();
    } else {
        // Normal stores
        for (; k + 1 < K; k += 2) {
            ...
            RADIX3_PIPELINE_2_FV_AVX2(k, K, sub_outputs, stage_tw, output_buffer, v_sqrt3_2);
        }
    }
#endif // __AVX2__
 ...
 *    - RADIX3_PIPELINE_4_*_AVX512
 *    - RADIX3_PIPELINE_2_*_AVX2
