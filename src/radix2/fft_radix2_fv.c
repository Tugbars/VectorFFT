//==============================================================================
// fft_radix2_fv.c - Forward Radix-2 Butterfly (P0+P1 OPTIMIZED!)
//==============================================================================
//
...
/**
 * @brief Ultra-optimized forward radix-2 butterfly (P0+P1 version)
 * 
 ...
 * - k=N/4: Twiddle W^(N/4) = -i (rotation, scalar optimized)
 * 
 ...
 * @note This function modifies output_buffer in-place
 */
void fft_radix2_fv(
    ...
    int sub_len)
{
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Special Case 2: k=N/4 (W^(N/4) = -i for forward transform)
    // ─────────────────────────────────────────────────────────────────────
 ...
 * 
 * RADIX-2 IS CRITICAL:
 * Radix-2 is the workhorse of mixed-radix FFTs. Every power-of-2 transform
 * uses radix-2 extensively. These P0+P1 optimizations provide 20-25% speedup
 * on the most common butterfly type, directly improving overall FFT performance.
 * 
 */