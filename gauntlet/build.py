...
def main():
    ...
    ap.add_argument('--src', default=str(HERE / 'bench_1d_vs_mkl.c'),
                    help='Source file to build (default: the gauntlet bench). The '
                         'gauntlet sources live beside this script in gauntlet/.')
